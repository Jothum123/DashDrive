...
export default function SearchScreen() {
    ...
    return (
        <StyledSafeAreaView className="flex-1 bg-white dark:bg-black">
            ...
            <View className="px-6 pt-10 pb-4 flex-row items-center justify-between z-50 bg-white dark:bg-black">
            ...
            <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
                ...
                <View className="px-6 py-2 flex-row" style={{ zIndex: 10 }}>
                    <View className="flex-1 bg-accent-light/10 dark:bg-zinc-800/20 rounded-[24px] p-2">
                    ...
                    <View className="ml-3 justify-center">
                        {stops.length < 4 && (
                            <TouchableOpacity
                                onPress={addStop}
                                className="h-12 w-12 items-center justify-center rounded-full bg-white dark:bg-zinc-900 shadow-sm border border-gray-100 dark:border-zinc-800"
                            >
                                <StyledIonicons name="add" size={24} color={colorScheme === 'dark' ? 'white' : 'black'} />
                            </TouchableOpacity>
                        )}
                        <TouchableOpacity className="mt-3 h-12 w-12 items-center justify-center rounded-full bg-white dark:bg-zinc-900 shadow-sm border border-gray-100 dark:border-zinc-800">
                            <StyledIonicons name="swap-vertical" size={20} color="#71717a" />
                        </TouchableOpacity>
                    </View>
                </View>

                <View className="h-[1px] bg-gray-100 dark:bg-zinc-800 w-full mt-4" />
            ...
            <View className="px-6 py-6 pb-10 bg-white dark:bg-black border-t border-gray-100 dark:border-zinc-900">
                <TouchableOpacity
