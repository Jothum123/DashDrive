                ...
                {stats.map((stat, i) => (
                    <div key={i} className="bg-white p-8 rounded-[40px] border border-slate-100 shadow-sm group hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-500">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <div className={cn(
                                "flex items-center gap-1 px-3 py-1.5 rounded-xl text-[10px] font-black tracking-wider",
            ...
            <div className="grid grid-cols-12 gap-8">
                    ...
                    <div className="flex items-center justify-between mb-10">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-2 px-4 py-2 bg-slate-50 rounded-xl border border-slate-100">
                                ...
                                <span className="text-[10px] font-bold text-slate-600 uppercase">Payouts</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-span-12 lg:col-span-4 space-y-8">
                    <div className="bg-slate-900 p-10 rounded-[40px] text-white relative overflow-hidden">
                        ...
                        <button className="w-full mt-10 py-5 bg-white/10 hover:bg-white/20 rounded-[24px] text-xs font-black uppercase tracking-widest transition-all border border-white/10">
                            Generate Report
                        </button>
                    </div>

                    <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm">
                        <h3 className="text-sm font-black text-slate-900 uppercase tracking-[0.2em] mb-8">Quick Limits</h3>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="border-b border-slate-50">
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Transaction ID</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Entity</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Type</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Amount</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Status</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4 text-right">Date</th>
                            </tr>
                        </thead>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.2em]">Finance & Reports</span>
                        <ChevronRight className="w-3 h-3 text-slate-300" />
                        <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.2em]">Insights</span>
                    </div>
                ...
                <div className="flex items-center gap-3 p-2 bg-white rounded-[32px] border border-slate-100 shadow-sm">
                    {['Overview', 'Earn Reports', 'Comm Reports', 'Analytics'].map((tab) => (
                        <button
                            key={tab}
                            onClick={() => setActiveTab(tab)}
                            className={cn(
                                "px-8 py-3.5 rounded-[24px] text-xs font-black uppercase tracking-widest transition-all duration-300",
                                activeTab === tab
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button className="flex items-center gap-3 px-8 py-4 bg-[#0089D1] text-white rounded-[24px] text-xs font-black uppercase tracking-widest hover:bg-[#007AB8] transition-all shadow-xl shadow-[#0089D1]/20">
