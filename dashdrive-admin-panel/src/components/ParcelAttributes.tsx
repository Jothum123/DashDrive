    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <button className="flex items-center gap-2.5 px-8 py-3 bg-white border border-slate-200 text-slate-600 rounded-2xl text-[11px] font-bold font-small-caps tracking-widest shadow-sm hover:bg-slate-50 transition-all">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="flex items-start gap-8">
                            ...
                            <div className="flex-1 space-y-4">
                                <div className="flex items-center justify-between">
                                    <div className="space-y-1">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-[10px] font-bold text-slate-300 uppercase tracking-widest">{attr.id}</span>
                                            <span className={cn(
                                ...
                                <div className="pt-6 border-t border-slate-50">
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-3">Auto-Assigned Categories</p>
                ...
                <div className="bg-slate-900 rounded-[48px] p-10 flex flex-col md:flex-row items-center gap-8 shadow-2xl relative overflow-hidden group border border-white/5 lg:col-span-2">
                    ...
                    <div className="relative z-10">
                        <button className="px-8 py-4 bg-white text-slate-900 rounded-2xl text-[10px] font-bold font-small-caps tracking-widest shadow-2xl hover:scale-105 active:scale-95 transition-all">
                            Configure AI Logic
                        </button>
                    </div>
                </div>
