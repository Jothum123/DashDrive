                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Automated User Comms</p>
                        </div>
                    </div>
                ...
                <div className="bg-slate-900 p-10 rounded-[60px] text-white shadow-2xl space-y-8 relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-white/30 uppercase tracking-widest mt-1">Automation for Drivers</p>
                        </div>
                    </div>
        ...
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm">
                <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Customer & Driver Push Alerts</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-2 text-[10px] font-black text-[#0089D1] uppercase tracking-widest">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* Customer Section */}
                    <div className="space-y-6">
                        <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest ml-4 mb-4">Customer Events</h4>
                        {[
                    ...
                    {/* Driver Section */}
                    <div className="space-y-6">
                        <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest ml-4 mb-4">Driver Events</h4>
                        {[
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Delivery Lifecycle (Customer)</p>
                        </div>
                    </div>
                    <div className="space-y-6">
                        {[
                ...
                <div className="bg-slate-900 p-10 rounded-[60px] text-white shadow-2xl space-y-8 relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-white/30 uppercase tracking-widest mt-1">Penalties & Refund Alerts</p>
                        </div>
                    </div>
                    <div className="space-y-6 relative z-10">
                        {[
            ...
            <div className="bg-white p-12 rounded-[60px] border border-slate-100 shadow-sm space-y-10">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-1">Lifecycle Approval Workflow</p>
                    </div>
                </div>
            ...
            <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm">
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Multi-Retailer Push Alerts</p>
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[
            ...
            <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm">
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">E-commerce Fulfillment Alerts</p>
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[
            ...
            <div className="bg-slate-900 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden">
                ...
                <div className="flex items-center gap-4 mb-10 relative z-10">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-rose-500 uppercase tracking-widest mt-1">Real-time Culinary Alerts</p>
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
                    {[
                        ...
                        <div key={i} className="p-6 bg-white/5 border border-white/10 rounded-[40px] space-y-4">
                            <div className="flex items-center justify-between">
                                <span className="text-[11px] font-black uppercase tracking-widest text-white/60">{ev.label}</span>
            ...
            <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm">
                <div className="flex items-center gap-6 mb-10">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-1">Digital Wallet & Loan Alerts</p>
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-6">
                        <h4 className="text-[10px] font-black text-indigo-500 uppercase tracking-widest ml-4">Wallet & Payments</h4>
                        {[
                    ...
                    <div className="space-y-6">
                        <h4 className="text-[10px] font-black text-emerald-500 uppercase tracking-widest ml-4">Loans & BNPL</h4>
                        {[
            ...
            <div className="bg-white p-12 rounded-[80px] border border-slate-100 shadow-sm space-y-12">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-1">
                                <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">External Core</span>
                                <div className="w-1 h-1 rounded-full bg-slate-200" />
                                <span className="text-[10px] font-black text-orange-500 uppercase tracking-[0.2em]">FCM Registry</span>
                            </div>
                            <h3 className="text-4xl font-black text-slate-900 tracking-tight">Firebase Configuration</h3>
                        </div>
                    </div>
                    <button className="flex items-center gap-3 px-8 py-4 bg-slate-50 border border-slate-100 rounded-[24px] text-[10px] font-black uppercase tracking-widest hover:bg-slate-100 transition-all">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    <div className="lg:col-span-2 space-y-8">
                        <div className="space-y-4">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">Service Account Content (JSON)</label>
                            <textarea
                        ...
                        <div className="bg-slate-900 p-10 rounded-[60px] text-white shadow-2xl relative overflow-hidden flex flex-col justify-between min-h-[400px]">
                            ...
                            <div className="space-y-8 relative z-10">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="p-6 bg-white/5 border border-white/10 rounded-[32px] flex items-center justify-between">
                                        <span className="text-[10px] font-black uppercase tracking-widest text-white/40">Last Sync</span>
                                        <span className="text-[10px] font-black text-white/60 uppercase tracking-widest">2 min ago</span>
                                    </div>
                                </div>
                            </div>
                            <button className="w-full py-5 bg-orange-500 text-white rounded-[28px] text-[10px] font-black uppercase tracking-widest shadow-xl shadow-orange-900/40 relative z-10 hover:scale-[1.02] active:scale-95 transition-all">Test Certificate</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <div className="w-1 h-1 rounded-full bg-slate-200" />
                                <span className="text-[10px] font-black text-[#0089D1] uppercase tracking-[0.2em]">Notifications</span>
                            </div>
