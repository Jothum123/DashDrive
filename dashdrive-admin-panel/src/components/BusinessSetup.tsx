        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 text-black">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-6">
                            <div className="w-24 h-24 bg-slate-50 border-2 border-dashed border-slate-200 rounded-[32px] flex flex-col items-center justify-center group hover:border-[#0089D1]/30 transition-all cursor-pointer">
                                ...
                                <span className="text-[8px] font-black text-slate-400 mt-2 uppercase">Logo</span>
                            </div>
            ...
            <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm">
                <div className="flex items-center justify-between mb-10">
                    ...
                    <button className="flex items-center gap-2 px-8 py-3.5 bg-slate-900 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-800 transition-all shadow-xl shadow-slate-900/10">Add Operating Branch</button>
                </div>
                    ...
                    {[
                        ...
                        <div key={i} className="p-8 bg-slate-50 rounded-[36px] border border-slate-100 group hover:bg-white hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <span className="text-[9px] font-black text-slate-400 bg-white border border-slate-100 px-3 py-1 rounded-full uppercase tracking-tighter">{branch.status}</span>
                            </div>
                            ...
                            <div className="mt-8 flex items-center justify-between pt-6 border-t border-slate-100">
                                <button className="text-[10px] font-black text-slate-900 hover:text-[#0089D1] transition-colors uppercase tracking-widest flex items-center gap-2">Manage Branch <ChevronRight className="w-3 h-3" /></button>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.2em]">Business</span>
                    </div>
                ...
                <div className="flex items-center gap-3 p-2 bg-white rounded-[32px] border border-slate-100 shadow-sm">
                    {['Enterprise Profile', 'Compliance', 'Branches', 'Taxes'].map((tab) => (
                        <button
                            key={tab}
