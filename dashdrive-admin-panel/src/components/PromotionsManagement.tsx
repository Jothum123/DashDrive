        ...
        <div className="space-y-8">
            ...
            {activeTab === 'Coupons' ? (
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] text-slate-400 font-bold font-small-caps mt-1 tracking-wider">{promo.id}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="space-y-2">
                                                <div className="flex justify-between items-center w-32">
                                                    <span className="text-[9px] font-bold text-slate-400 font-small-caps tracking-widest">{promo.usage} used</span>
                                                    <span className="text-[9px] font-bold text-slate-300 uppercase leading-none">{Math.round((promo.usage / promo.limit) * 100)}%</span>
                                                </div>
                ...
                <div className="bg-white p-24 rounded-[40px] shadow-soft border border-slate-100 flex flex-col items-center justify-center text-center">
                    ...
                    <button className="mt-8 px-8 py-3 bg-slate-900 text-white rounded-2xl text-[10px] font-bold font-small-caps tracking-widest hover:scale-105 active:scale-95 transition-all shadow-xl shadow-slate-900/10 uppercase">
