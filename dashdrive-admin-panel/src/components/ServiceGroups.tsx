...
export const ServiceGroups: React.FC = () => {
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black text-[#0089D1] uppercase tracking-[0.2em]">Service Architecture</span>
                        </div>
    ...
    const renderActionsBar = () => (
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 px-4">
            ...
            <button className="flex items-center gap-3 px-8 py-4 bg-slate-900 text-white rounded-[24px] text-xs font-black uppercase tracking-widest hover:bg-slate-800 transition-all shadow-xl shadow-slate-900/10 active:scale-95">
        ...
        <div className="max-w-[1700px] mx-auto space-y-12 pb-20 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-in fade-in slide-in-from-bottom-6 duration-700">
                    ...
                    <div key={group.id} className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 relative overflow-hidden group hover:shadow-2xl hover:border-blue-100 transition-all duration-500">
                        ...
                        <div className="p-6 bg-slate-50 rounded-[40px] border border-slate-100 flex items-center justify-between relative z-10">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-xs font-black text-slate-900 uppercase tracking-widest">{group.servicesCount} Services</span>
                            </div>
                            <button className="flex items-center gap-2 text-[10px] font-black text-[#0089D1] uppercase tracking-[0.2em] hover:translate-x-1 transition-transform">
                                Manage <ArrowRight className="w-3 h-3" />
                            </button>
                        </div>

                        <div className="flex items-center gap-4 relative z-10">
                            <button className="flex-1 py-4 bg-slate-900 text-white rounded-[28px] text-[10px] font-black uppercase tracking-widest shadow-xl shadow-slate-900/10 hover:translate-y-[-2px] active:translate-y-0 transition-all">
                                Edit Group
                            </button>
                            <button
                                onClick={() => toggleStatus(group.id)}
                                className={cn(
                                    "flex items-center gap-3 px-6 py-4 rounded-[28px] text-[10px] font-black uppercase tracking-widest border transition-all",
                                    group.status === 'Active'
                ...
                <button className="flex flex-col items-center justify-center p-12 rounded-[60px] border-4 border-dashed border-slate-100 text-slate-300 hover:border-blue-100 hover:text-blue-500 hover:bg-blue-50/30 transition-all duration-500 group">
                    ...
                    <span className="text-lg font-black uppercase tracking-[0.2em]">Create New Group</span>
            ...
            <div className="max-w-4xl mx-auto p-10 bg-slate-900 rounded-[60px] text-white shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-6 flex flex-col md:flex-row items-center gap-10">
                    ...
                    <div>
                        <h4 className="text-2xl font-black italic tracking-tight uppercase">Service Group Logic</h4>
                        ...
                        <div className="flex gap-4 mt-8">
                            <button className="px-8 py-3 bg-white text-slate-900 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:scale-[1.05] transition-transform">Documentation</button>
                            <button className="px-8 py-3 bg-white/10 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest border border-white/20 hover:bg-white/20 transition-all">Setup Guide</button>
                        </div>
                    </div>
                </div>
            </div>
