                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black text-[#0089D1] uppercase tracking-[0.2em]">Content Management</span>
                        </div>
        ...
        <div className="max-w-[1700px] mx-auto space-y-12 pb-20 px-4">
            ...
            <div className="flex flex-col lg:flex-row gap-10 min-h-[600px]">
                ...
                <div className="lg:w-[400px] shrink-0 space-y-8 animate-in fade-in slide-in-from-left-8 duration-700">
                    <div className="bg-white p-8 rounded-[48px] border border-slate-100 shadow-sm space-y-8">
                        <div className="space-y-4">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-4">Search Articles</label>
                        ...
                        <button className="w-full py-6 bg-slate-900 text-white rounded-[32px] text-xs font-black uppercase tracking-[0.3em] shadow-xl shadow-slate-900/10 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-3">
                        ...
                        <div className="p-6 bg-blue-50/50 rounded-[32px] border border-blue-100/50 space-y-4">
                            <div className="flex items-center gap-3 text-blue-600">
                                ...
                                <h4 className="text-[10px] font-black uppercase tracking-widest">Global SEO Status</h4>
                            </div>
                    ...
                    <div className="bg-slate-900 p-8 rounded-[48px] text-white space-y-6 relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-4 relative z-10">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-white/40 uppercase tracking-widest">Last 30 Days</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4 relative z-10">
                            <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                                <span className="text-[10px] font-black text-white/30 uppercase tracking-widest block mb-1">Reads</span>
                                <span className="text-xl font-black">12.4K</span>
                            </div>
                            <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                                <span className="text-[10px] font-black text-white/30 uppercase tracking-widest block mb-1">Conversions</span>
                ...
                <div className="flex-1 space-y-8 animate-in fade-in slide-in-from-right-8 duration-700">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="col-span-full py-8 flex items-center border border-dashed border-slate-200 rounded-[32px] justify-between px-10">
                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest italic">Showing 3 of 127 articles</span>
                            <div className="flex items-center gap-4">
            ...
            <div className="max-w-4xl mx-auto p-12 bg-white rounded-[64px] border border-slate-100 shadow-sm space-y-10 relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
                    ...
                    <div>
                        <h4 className="text-2xl font-black tracking-tight text-slate-900 uppercase italic">Blog Architecture & SEO</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                    <div className="p-6 bg-slate-50 rounded-[32px] border border-slate-100 space-y-3">
                        ...
                        <h5 className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Share Cards</h5>
                    ...
                    <div className="p-6 bg-slate-50 rounded-[32px] border border-slate-100 space-y-3">
                        ...
                        <h5 className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Discussion Hub</h5>
                    ...
                    <div className="p-6 bg-slate-50 rounded-[32px] border border-slate-100 space-y-3">
                        ...
                        <h5 className="text-[10px] font-black text-slate-900 uppercase tracking-widest">RSS Endpoint</h5>
