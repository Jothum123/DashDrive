        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 px-4 mt-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black text-[#0089D1] uppercase tracking-[0.2em]">Growth & Distribution</span>
                        </div>
            ...
            <div className="flex items-center gap-4">
                <button
                    ...
                    className="flex items-center gap-3 px-8 py-4 bg-white border border-slate-200 text-slate-400 rounded-[24px] text-xs font-black uppercase tracking-widest hover:bg-slate-50 hover:text-slate-600 transition-all focus:ring-4 focus:ring-slate-100"
                >
                    <RotateCcw className="w-5 h-5" /> Reset
                </button>
                <button className="flex items-center gap-3 px-10 py-4 bg-[#0089D1] text-white rounded-[24px] text-xs font-black uppercase tracking-widest hover:bg-[#007AB8] transition-all shadow-xl shadow-[#0089D1]/20 font-display focus:ring-4 focus:ring-[#007AB8]/20">
                ...
                <div className="lg:w-1/2 space-y-10">
                    <div className="bg-white p-12 rounded-[60px] border border-slate-100 shadow-sm space-y-10 relative overflow-hidden group">
                        ...
                        <div className="flex items-center justify-between relative z-10">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-2">Mobile Application Distribution</p>
                                </div>
                            </div>
                        ...
                        <div className="space-y-8 relative z-10">
                            <div className="space-y-4">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-4">Google Play Store URL</label>
                                <div className="relative group/field">
                                    ...
                                    />
                                    <button className="absolute right-6 top-1/2 -translate-y-1/2 flex items-center gap-2 text-[10px] font-black text-[#0089D1] uppercase tracking-widest hover:bg-white px-3 py-1.5 rounded-full transition-all">
                            ...
                            <div className="space-y-4">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-4">Apple App Store URL</label>
                                <div className="relative group/field">
                        ...
                        <div className="pt-6 relative z-10 flex flex-col gap-6">
                            <div className="p-8 bg-slate-50 rounded-[40px] border border-slate-100 space-y-6">
                                <div className="flex items-center justify-between">
                                    <h4 className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Active Channels</h4>
                                    <span className="text-[10px] font-black text-emerald-500 uppercase tracking-widest bg-emerald-50 px-3 py-1 rounded-full border border-emerald-100 italic">2 Stable Releases</span>
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex items-center gap-3 p-4 bg-white rounded-2xl border border-slate-100 group/chan hover:border-[#0089D1] transition-all cursor-pointer">
                                        ...
                                        <span className="text-[10px] font-black text-slate-600 uppercase tracking-widest">Production Hub</span>
                                    </div>
                                    <div className="flex items-center gap-3 p-4 bg-white rounded-2xl border border-slate-100 group/chan hover:border-amber-400 transition-all cursor-pointer">
                                        ...
                                        <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest italic group-hover/chan:text-amber-500 transition-colors">Staging Dev</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="lg:w-1/2 space-y-10">
                    <div className="bg-slate-900 p-12 rounded-[60px] text-white space-y-10 shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-6 relative z-10">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] mt-2 italic">Landing Page Promotion</p>
                            </div>
                        </div>

                        <div className="space-y-8 relative z-10">
                            <div className="space-y-4">
                                <label className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em] ml-4">Download Section Title</label>
                                <input
                                    type="text"
                                    value={downloadTitle}
                            ...
                            <div className="space-y-4">
                                <label className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em] ml-4">Marketing Description</label>
                                <textarea
                                    rows={4}
                                    value={downloadDesc}
                        ...
                        <div className="pt-6 relative z-10 grid grid-cols-2 gap-6">
                            <button className="flex items-center justify-center gap-3 w-full py-5 bg-white text-slate-900 rounded-[32px] text-[10px] font-black uppercase tracking-[0.2em] hover:scale-[1.03] active:scale-95 transition-all">
                                <ImageIcon className="w-5 h-5" /> Change Assets
                            </button>
                            <button className="flex items-center justify-center gap-3 w-full py-5 bg-blue-500 text-white rounded-[32px] text-[10px] font-black uppercase tracking-[0.2em] hover:bg-blue-600 transition-all">
                    ...
                    <div className="p-10 bg-emerald-50/50 rounded-[50px] border border-emerald-100 flex items-start gap-6 group hover:bg-emerald-50 transition-colors duration-500">
                        ...
                        <div className="space-y-3">
                            <h4 className="text-sm font-black text-emerald-900 uppercase tracking-widest">Growth Engine Active</h4>
                            ...
                            <button className="flex items-center gap-2 text-[10px] font-black text-emerald-600 uppercase tracking-widest hover:underline transition-all">
