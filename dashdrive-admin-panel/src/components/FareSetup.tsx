    ...
    return (
        <div className="space-y-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <button className="flex items-center gap-2.5 px-8 py-3 bg-slate-900 text-white rounded-2xl text-[10px] font-bold font-small-caps tracking-widest shadow-2xl shadow-slate-900/10 hover:scale-105 active:scale-95 transition-all">
                        ...
                        <div className="flex items-center justify-between mb-8">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-400 font-bold font-small-caps tracking-wider mt-1">Standardized Metrics</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative z-10">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <button className="text-[10px] font-bold font-small-caps tracking-widest text-primary mt-5 flex items-center gap-2 hover:gap-3 transition-all">
...
const ConfigInput: React.FC<{ label: string; value: string; unit: string }> = ({ label, value, unit }) => (
    <div className="space-y-2">
        <label className="text-[10px] font-bold text-slate-400 font-small-caps tracking-widest">{label}</label>
    ...
    <tr className="hover:bg-slate-50/50 transition-colors group">
        ...
        <td className="px-8 py-5">
            <div className="flex items-center gap-2.5">
                ...
                <span className="text-[10px] font-bold font-small-caps text-emerald-600 tracking-widest">ENABLED</span>
            </div>
        </td>
        <td className="px-8 py-5">
