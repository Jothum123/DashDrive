                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black text-[#0089D1] uppercase tracking-[0.2em]">Intelligent Automation</span>
                        </div>
            ...
            <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="flex items-center justify-between relative z-10">
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-1">OpenAI API Connection Hub</p>
                            </div>
                        </div>

                        <div className="flex items-center gap-8">
                            <button className="flex items-center gap-2 text-[10px] font-black text-[#0089D1] uppercase tracking-widest hover:underline transition-all group/link">
                    ...
                    <div className="space-y-10 relative z-10">
                        <div className="space-y-4">
                            <div className="flex items-center justify-between px-4">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">OpenAI API Key *</label>
                                <span className="text-[10px] font-black text-amber-600 uppercase tracking-widest flex items-center gap-1.5 bg-amber-50 px-3 py-1 rounded-full">
                        ...
                        <div className="space-y-4">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-4">OpenAI Organization ID *</label>
                            <div className="relative group">
                                <input
                                    type="text"
                                    value={orgId}
                    ...
                    <div className="pt-4 flex flex-col gap-6 relative z-10">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-6 bg-slate-50 rounded-[32px] border border-slate-100 space-y-3 hover:border-blue-100 transition-colors group/feat">
                                ...
                                <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest">Smart Support</h4>
                            ...
                            <div className="p-6 bg-slate-50 rounded-[32px] border border-slate-100 space-y-3 hover:border-emerald-100 transition-colors group/feat">
                                ...
                                <h4 className="text-xs font-black text-slate-900 uppercase tracking-widest">Auto Logistics</h4>
                                <p className="text-[10px] font-medium text-slate-500 leading-relaxed">
                        ...
                        <button className="w-full py-6 bg-slate-900 text-white rounded-[40px] text-sm font-black uppercase tracking-[0.3em] shadow-2xl shadow-slate-900/30 hover:scale-[1.01] active:scale-95 transition-all active:shadow-none">
                            Save AI Information
                        </button>
                    </div>
                </div>
                ...
                <div className="mt-8 flex items-start gap-4 p-8 bg-amber-50/50 rounded-[40px] border border-amber-100/50">
                    ...
                    <div className="space-y-2">
                        <h4 className="text-sm font-black text-amber-900 uppercase tracking-widest italic">Security Best Practice</h4>
