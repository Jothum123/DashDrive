                ...
                {[
                    ...
                    <div key={stat.label} className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm">
                        ...
                        <div className="flex items-end gap-3">
                            ...
                            <span className={cn("text-[10px] font-black pb-1 uppercase", stat.trend.startsWith('+') ? 'text-emerald-500' : 'text-rose-500')}>{stat.trend}</span>
                        </div>
                    </div>
                ))}
            </div>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-slate-50/50">
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Bill ID / Customer</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Service Provider</th>
                            ...
                            {bills.map((bill) => (
                                <tr key={bill.id} className="group hover:bg-slate-50/50 transition-all duration-300">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{bill.id}</span>
                                    ...
                                    <td className="px-8 py-6">
                                        ...
                                        <p className="text-[10px] font-bold text-slate-400 uppercase mt-0.5">{bill.type}</p>
                                    </td>
