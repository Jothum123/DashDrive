...
export const Trips: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            ...
            {/* Tabs */}
            <div className="flex items-center gap-1.5 bg-slate-100/50 p-1.5 rounded-[22px] w-fit border border-slate-200/50">
                {['All', 'Ongoing', 'Completed', 'Cancelled'].map((tab) => (
                    <button
                        key={tab}
                        onClick={() => setActiveTab(tab as any)}
                        className={cn(
                            "px-7 py-2.5 rounded-[18px] text-[10px] font-bold font-small-caps tracking-widest transition-all",
                            activeTab === tab
                                ...
                                <tr key={trip.id} className="hover:bg-slate-50/50 transition-colors group">
                                    <td className="px-8 py-6">
                                        ...
                                        <div className="flex items-center gap-2 mt-2">
                                            ...
                                            <span className="text-[10px] text-slate-400 font-bold font-small-caps tracking-wider">{trip.time}</span>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-5">
                                            <div className="text-right">
                                                <p className="text-[9px] font-bold text-slate-400 font-small-caps tracking-widest">Origin</p>
                                            ...
                                            <div>
                                                <p className="text-[9px] font-bold text-slate-400 font-small-caps tracking-widest">Target</p>
                                    ...
                                    <td className="px-8 py-6">
                                        ...
                                        <p className="text-[10px] text-slate-400 font-bold font-small-caps tracking-wider mt-1.5">{trip.distance} • {trip.payment}</p>
                                    </td>
                                    <td className="px-8 py-6">
                                        <span className={cn(
