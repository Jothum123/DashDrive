                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Core Identity & Contact</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-10">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Regional & Financial Settings</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-slate-900 p-10 rounded-[60px] shadow-2xl shadow-slate-900/40 space-y-8 relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-4 relative z-10">
                            ...
                            <div>
                                ...
                                <p className="text-xs font-bold text-white/40 uppercase tracking-widest mt-1">Compliance & Branding</p>
                            </div>
                        </div>

                        <div className="space-y-6 relative z-10">
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Trade License Number</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Company Copyright</label>
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Commission & Tax Scale</p>
                        </div>
                    </div>

                    <div className="space-y-6">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Trip Commission (%)</label>
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">VAT (%)</label>
                ...
                <div className="lg:col-span-2 bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Socket & Radius</p>
                        </div>
                    </div>

                    <div className="grid grid-cols-2 gap-8">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">WebSocket URL</label>
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">WebSocket Port</label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className="p-6 bg-white/5 border border-white/10 rounded-[32px]">
                                <p className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-3">{item.label}</p>
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Signup & Identity</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 flex-1">
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Via Driver App</p>
                            </div>
                            <button
                        ...
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Document Required</p>
                            </div>
                            <button
                        ...
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Two-way ratings</p>
                            </div>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Levels & Retention</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 flex-1">
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Tiered Rewards</p>
                            </div>
                            <button
                        ...
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Earn per trip</p>
                            </div>
                            <button
                        ...
                        <div className="space-y-3 pt-2">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">$1.00 Equivalent To Points</label>
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Workload Management</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 flex-1">
                        <div className="space-y-3">
                            <div className="flex items-center justify-between px-1">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Max Parcel Limit</label>
                        ...
                        <div className="pt-4 border-t border-slate-50 space-y-4">
                            <h4 className="text-[10px] font-black text-slate-900 uppercase tracking-widest ml-1">Cash Handling Setup</h4>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-tighter">Max to Hold ($)</p>
                                ...
                                <div className="space-y-2">
                                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-tighter">Min to Pay ($)</p>
                ...
                <div className="lg:col-span-2 bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Review required before update lives</p>
                        </div>
                    </div>
                ...
                <div className="lg:col-span-1 bg-slate-900 p-10 rounded-[60px] text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-white/30 uppercase tracking-widest mt-1">Identity Verification</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 relative z-10 mt-8">
                        ...
                        <div className="space-y-4">
                            <p className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Initiation Triggers</p>
                            <div className="space-y-3">
                                {[
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Status & Security</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 flex-1">
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                <p className="text-sm font-black text-slate-900 leading-none">Strict Verification</p>
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">OTP / ID Required</p>
                            </div>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Ratings & Feedback</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 flex-1">
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Stars & Feedback</p>
                            </div>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Tiers & Retention</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 flex-1">
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Bronze, Silver, Gold</p>
                            </div>
                            <button
                ...
                <div className="bg-slate-900 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden group lg:col-span-2">
                    ...
                    <div className="flex items-center gap-6 mb-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-emerald-400/50 uppercase tracking-[0.2em] mt-1">Earnings & Redemption</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">$1.00 Equivalent To Points</label>
                        ...
                        <div className="p-6 bg-white/5 border border-white/10 rounded-[32px]">
                            <p className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-3 leading-relaxed">System automatically converts spending based on this ratio for trips and payments.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Prepaid Controls</p>
                        </div>
                        <div className="ml-auto">
                            <button
                    ...
                    <div className="space-y-6 flex-1">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Minimum Add Amount ($)</label>
                            <input type="number" defaultValue="10" className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-[28px] text-sm font-black text-slate-900" />
                        </div>
                        <p className="text-[11px] font-bold text-slate-400 px-2 leading-relaxed">
            ...
            <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Stops & Standstills</p>
                    </div>
                </div>
                <div className="space-y-6 flex-1">
                    <p className="text-[11px] font-bold text-slate-400 px-2 leading-relaxed">
                    ...
                    <div className="space-y-3">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Start Count Idle Fee After (Min)</label>
            ...
            <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Extended Duration</p>
                    </div>
                </div>
                <div className="space-y-6 flex-1">
                    <p className="text-[11px] font-bold text-slate-400 px-2 leading-relaxed">
                    ...
                    <div className="space-y-3">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Start Count Delay Fee After (Min)</label>
                        <input type="number" defaultValue="5" className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-[28px] text-sm font-black text-slate-900 focus:bg-white transition-all outline-none" />
                    </div>
                </div>
            </div>
            ...
            <div className="bg-slate-900 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden group">
                ...
                <div className="flex items-center gap-6 mb-10">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-rose-400/50 uppercase tracking-[0.2em] mt-1">Penalty Orchestration</p>
                    </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
                    <div className="space-y-3">
                        <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Cancellation Fee (NGN)</label>
                    ...
                    <div className="space-y-3">
                        <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Free Window (Minutes)</label>
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Multi-Stop Settings</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 flex-1">
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Multi-Destination</p>
                            </div>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Timeouts & Security</p>
                        </div>
                    </div>

                    <div className="space-y-6 flex-1">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Request Active Time (Min)</label>
                            <input type="number" defaultValue="5" className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-[28px] text-sm font-black text-slate-900" />
                        </div>
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                <p className="text-sm font-black text-slate-900 leading-none">OTP Verification</p>
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Start Trip Securely</p>
                            </div>
                            <button
                ...
                <div className="bg-slate-900 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden group lg:col-span-1">
                    ...
                    <div className="flex items-center gap-6 mb-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-purple-400/50 uppercase tracking-[0.2em] mt-1">Advanced Bookings</p>
                        </div>
                        <div className="ml-auto">
                            <button
                    ...
                    <div className="space-y-6">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-3">
                                <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Min Lead (Min)</label>
                            ...
                            <div className="space-y-3">
                                <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Max Advance (Days)</label>
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Driver Notify Lead (Min)</label>
                ...
                <div className="bg-emerald-900 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden group lg:col-span-2">
                    ...
                    <div className="flex items-center gap-6 mb-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-emerald-400/50 uppercase tracking-[0.2em] mt-1">Dynamic Pricing</p>
                        </div>
                        <div className="ml-auto">
                            <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Increase Fare Rate (%)</label>
                            <div className="relative">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Dispute & Operational Insights</p>
                            </div>
                        </div>
                        <button className="flex items-center gap-2 px-6 py-3 bg-slate-900 text-white rounded-full text-xs font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all">
                    ...
                    <div className="overflow-hidden border border-slate-100 rounded-[40px]">
                        <table className="w-full text-left">
                            <thead className="bg-slate-50 border-b border-slate-100">
                                <tr>
                                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Cancellation Reason</th>
                            ...
                            <tbody className="divide-y divide-slate-50">
                                {[
                                    ...
                                    <tr key={idx} className="group hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-8 py-6">
                                            <span className="px-4 py-1.5 bg-slate-100 rounded-full text-[10px] font-black text-slate-500 uppercase tracking-tight">{item.type}</span>
                                        </td>
                                        <td className="px-8 py-6">
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Customer Visibility</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 flex-1">
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Live Link Auto-Send</p>
                            </div>
                            <button
                ...
                <div className="bg-slate-900 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden group lg:col-span-2">
                    ...
                    <div className="flex items-center gap-6 mb-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-rose-400/50 uppercase tracking-[0.2em] mt-1">Failed Delivery Logic</p>
                        </div>
                        <div className="ml-auto">
                            <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        <div className="space-y-6">
                            <div className="space-y-3">
                                <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Limit Return Time For Driver</label>
                            ...
                            <div className="space-y-3">
                                <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Late Return Penalty ($)</label>
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Limits & Units</p>
                        </div>
                    </div>

                    <div className="space-y-6 flex-1">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">System Weight Unit</label>
                        ...
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Enforce Max Limit</p>
                            </div>
                            <button
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Max Parcel Weight (Kg)</label>
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col lg:col-span-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Return & Return Logic Analytics</p>
                            </div>
                        </div>
                        <button className="flex items-center gap-2 px-6 py-3 bg-slate-900 text-white rounded-full text-xs font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all">
                            <Plus className="w-4 h-4" />
                    ...
                    <div className="overflow-hidden border border-slate-100 rounded-[40px]">
                        <table className="w-full text-left">
                            <thead className="bg-slate-50 border-b border-slate-100">
                                <tr>
                                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">SL</th>
                                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Cancellation Reason</th>
                                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Type</th>
                                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">User</th>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-emerald-600 p-10 rounded-[60px] text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-6 mb-10 relative z-10">
                        ...
                        <div>
                            <h3 className="text-xl font-black tracking-tight uppercase">Feature Status</h3>
                            <p className="text-[10px] font-black text-emerald-200/50 uppercase tracking-[0.2em] mt-1">Global Engine</p>
                        </div>
                    </div>
                    <div className="space-y-6 relative z-10">
                        <div className="flex items-center justify-between p-6 bg-white/5 border border-white/10 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] text-emerald-100/30 mt-1 uppercase">Instant Delivery On/Off</p>
                            </div>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 lg:col-span-2">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Base & Distance Rules</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 bg-slate-50 px-6 py-3 rounded-full border border-slate-100">
                            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Surge Mode</span>
                            <button
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Base Delivery Charge ($)</label>
                            <input
                                type="number"
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Extra Fee Per KM ($)</label>
                            <input
                                type="number"
                ...
                <div className="bg-slate-900 p-10 rounded-[60px] text-white shadow-2xl space-y-8 flex flex-col justify-center relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 mb-2">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em] mt-1">Value Gate</p>
                        </div>
                    </div>
                    <div className="relative">
                        <input
                        ...
                        />
                        <span className="absolute right-0 bottom-2 text-sm font-black text-white/20 uppercase tracking-widest">NGN / USD</span>
                    </div>
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">SLA Planning</p>
                        </div>
                    </div>
                    <div className="space-y-6">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-5 bg-slate-50 rounded-[28px] border border-slate-100">
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-tighter mb-2">Est. Delivery (Min)</p>
                                <input
                                    type="number"
                            ...
                            <div className="p-5 bg-slate-50 rounded-[28px] border border-slate-100">
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-tighter mb-2">Prep Time (Min)</p>
                                <input
                                    type="number"
                                    value={martPrepTime}
                        ...
                        <div className="flex items-center justify-between px-6 py-4 bg-slate-900 rounded-[24px] text-white">
                            <span className="text-[10px] font-black uppercase tracking-widest">Scheduled Orders</span>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Geo Coverage</p>
                        </div>
                    </div>
                    <div className="space-y-8 flex-1 flex flex-col justify-center">
                        <div className="space-y-4">
                            <div className="flex justify-between items-end">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Service Radius (KM)</label>
                        ...
                        <div className="p-6 bg-slate-50 rounded-[32px] border border-dashed border-slate-200 text-center">
                            <p className="text-[10px] font-bold text-slate-400 uppercase leading-relaxed font-mono">
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Allocation Engine</p>
                        </div>
                    </div>
                    <div className="space-y-4">
                        ...
                        <div className="p-6 bg-slate-50 rounded-[32px] flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-slate-400 uppercase">Support Multiple Orders</p>
                            </div>
                            <button
                ...
                <div className="bg-emerald-50 p-10 rounded-[60px] border border-emerald-100 shadow-sm space-y-8 relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-emerald-600 uppercase tracking-widest mt-1">Confirmation Rules</p>
                        </div>
                    </div>
                    <div className="space-y-4 relative z-10">
                        <div className="p-6 bg-white rounded-[32px] border border-emerald-100 space-y-4 shadow-sm">
                            <p className="text-[10px] font-black text-emerald-900 uppercase tracking-widest">Confirmation Mode</p>
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Limits & Charges</p>
                        </div>
                    </div>
                    <div className="space-y-6">
                        <div className="space-y-3">
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Cancellation Fee ($)</label>
                            <input
                                type="number"
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Flexible Gateways</p>
                        </div>
                    </div>
                    <div className="space-y-3">
                        {[
                            ...
                            <div key={i} className="flex items-center justify-between p-5 bg-slate-50 rounded-[24px] border border-slate-100">
                                <span className="text-[10px] font-black text-slate-900 uppercase tracking-tighter">{pay.label}</span>
                                <button
                ...
                <div className="bg-slate-900 p-10 rounded-[60px] text-white shadow-2xl space-y-8 relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em] mt-1">Bulk Logistics</p>
                        </div>
                    </div>
                    <div className="space-y-6 relative z-10">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-white/40 uppercase tracking-widest">Cart Weight Limit (KG)</label>
                            <input
                                type="number"
                                value={martMaxWeight}
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-white/40 uppercase tracking-widest">Heavy Handling Fee ($)</label>
                            <input
                                type="number"
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Multi-Channel Config</p>
                        </div>
                    </div>
                    <div className="space-y-4">
                        <div className="p-6 bg-slate-50 rounded-[32px] border border-slate-100 space-y-4">
                            <p className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Active Channels</p>
                            <div className="grid grid-cols-2 gap-3">
                                <button
                                    onClick={() => setMartNotifySMS(!martNotifySMS)}
                                    className={cn(
                                        "py-4 rounded-2xl text-[10px] font-black uppercase transition-all",
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">SLA & Commissions</p>
                        </div>
                    </div>

                    <div className="space-y-6 flex-1">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Avg. Preparation Time (Min)</label>
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Merchant Commission (%)</label>
                            <div className="relative">
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Fees & Materials</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 flex-1">
                        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Auto-add to checkout</p>
                            </div>
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Default Base Fee (NGN)</label>
                ...
                <div className="bg-slate-900 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-6 mb-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em] mt-1">Radius & Capacity</p>
                        </div>
                    </div>

                    <div className="space-y-6">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Delivery Radius (KM)</label>
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Min. Order Value (NGN)</label>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Cross-Service Eligibility & Automation</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px]">
                                <div>
                                    ...
                                    <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Small Order Instance Approval</p>
                                </div>
                                <button
                            ...
                            <div className="space-y-3">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Auto-Refund Threshold (NGN)</label>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between p-6 bg-slate-100 rounded-[32px]">
                                <div>
                                    ...
                                    <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">Refund Request Window</p>
                                </div>
                            ...
                            <div className="space-y-3">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Period (Hours)</label>
                ...
                <div className="bg-slate-900 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-6 mb-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-rose-400/50 uppercase tracking-[0.2em] mt-1">Service Specific Toggles</p>
                        </div>
                    </div>
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col lg:col-span-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Predefined Dispute Justifications</p>
                            </div>
                        </div>
                        <button className="flex items-center gap-2 px-6 py-3 bg-slate-900 text-white rounded-full text-xs font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all">
                            <Plus className="w-4 h-4" />
                    ...
                    <div className="overflow-hidden border border-slate-100 rounded-[40px]">
                        <table className="w-full text-left">
                            <thead className="bg-slate-50 border-b border-slate-100">
                                <tr>
                                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Justification</th>
                                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Primary Service</th>
                                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Automation Pool</th>
                                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest text-right">Action</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-50">
                                {[
                                    ...
                                    <tr key={idx} className="group hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-8 py-6">
                                            <span className="px-4 py-1.5 bg-slate-100 rounded-full text-[10px] font-black text-slate-500 uppercase tracking-tight">{item.service}</span>
                                        </td>
                                        <td className="px-8 py-6">
                                            <span className="flex items-center gap-2 text-sm font-bold text-slate-600">
                ...
                <div className="bg-rose-900 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-6 mb-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-rose-400/50 uppercase tracking-[0.2em] mt-1">Core Safety Engine</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between p-6 bg-white/5 border border-white/10 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] text-white/30 mt-1 uppercase">Master In-App Alert</p>
                            </div>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col lg:col-span-2">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Delay & Post-Trip Windows</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-4">
                            <div className="p-6 bg-slate-50 rounded-[32px] border border-slate-100">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-4">Min. Trip Delay (Mins)</label>
                                <div className="flex items-center gap-6">
                                    <input
                                        type="number"
                                        value={tripDelayMins}
                        ...
                        <div className="space-y-4">
                            <div className="p-6 bg-slate-900 rounded-[32px] text-white border border-slate-800 shadow-xl">
                                <label className="text-[10px] font-black text-white/30 uppercase tracking-widest block mb-4">Post-Trip Window (Mins)</label>
                                <div className="flex items-center gap-6">
                                    <input
                                        type="number"
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Direct Hotline Setup</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Number Type</label>
                            <div className="flex gap-2">
                                {['Phone', 'Telephone', 'Hotline'].map(type => (
                                    <button
                                        ...
                                        className={cn(
                                            "flex-1 py-3 rounded-2xl text-[10px] font-black uppercase tracking-tight transition-all",
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Multi-Response Escalation</p>
                            </div>
                        </div>
                        <button className="flex items-center gap-2 px-6 py-3 bg-slate-900 text-white rounded-full text-xs font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all">
                            <Plus className="w-4 h-4" />
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Predefined Alert Categories</p>
                        </div>
                    </div>
                    <button className="flex items-center gap-2 px-8 py-4 bg-slate-900 text-white rounded-full text-xs font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-xl shadow-slate-200">
                ...
                <div className="overflow-hidden border border-slate-100 rounded-[50px]">
                    <table className="w-full text-left">
                        <thead className="bg-slate-900 text-white">
                            <tr>
                                <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest opacity-40">SL</th>
                                <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest">Incident Category</th>
                                <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest">Actor Type</th>
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">In-App Safety Guidelines</p>
                        </div>
                    </div>
                    <button className="flex items-center gap-2 px-8 py-4 bg-emerald-500 text-white rounded-full text-xs font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-xl shadow-emerald-100">
                        <Plus className="w-5 h-5" />
                        Add Precaution
                    </button>
                </div>
                        ...
                        <div key={i} className="group bg-white p-8 rounded-[50px] border border-slate-100 shadow-sm hover:shadow-2xl hover:scale-[1.01] transition-all">
                            <div className="flex items-start justify-between mb-6">
                                <div className="space-y-1">
                                    <span className="px-4 py-1.5 bg-slate-900 text-white rounded-full text-[9px] font-black uppercase tracking-widest">
                                        For: {prec.target}
                                    </span>
                            ...
                            <div className="flex items-center justify-between pt-6 border-t border-slate-50">
                                <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest">Guideline Status</span>
            ...
            <div className="bg-white p-12 rounded-[80px] border border-slate-100 shadow-sm space-y-10 relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between relative z-10">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Acquisition & Growth Engine</p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
                    ...
                    <div className="space-y-8 p-10 bg-slate-50 rounded-[60px] border border-slate-100/50">
                        ...
                        <div className="space-y-4">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Earnings To Each Referral ($)</label>
                            <div className="relative">
                    ...
                    <div className="space-y-8 p-10 bg-slate-900 rounded-[60px] text-white shadow-2xl">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Discount (%)</label>
                                <div className="relative">
                                    <input
                                        type="number"
                            ...
                            <div className="space-y-4">
                                <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Validity (Days)</label>
                                <input
                                    type="number"
            ...
            <div className="bg-slate-900 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between relative z-10 mb-12">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-indigo-400/50 uppercase tracking-[0.2em] mt-1">Partner Network Expansion</p>
                        </div>
                    </div>
                    <button
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
                    ...
                    <div className="space-y-8 p-10 bg-white/5 border border-white/10 rounded-[60px]">
                        ...
                        <div className="space-y-4">
                            <label className="text-[10px] font-black text-white/30 uppercase tracking-widest ml-1">Earnings To Each Referral ($)</label>
                            <div className="relative">
                    ...
                    <div className="space-y-8 p-10 bg-indigo-500 rounded-[60px] text-white shadow-2xl relative overflow-hidden">
                        ...
                        <div className="space-y-4 relative z-10">
                            <label className="text-[10px] font-black text-white/50 uppercase tracking-widest ml-1">Bonus In Wallet ($)</label>
                            <div className="relative">
                ...
                <div className="bg-indigo-600 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-6 mb-10 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-indigo-200/50 uppercase tracking-[0.2em] mt-1">Marketplace Gate</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 relative z-10">
                        <div className="flex items-center justify-between p-6 bg-white/5 border border-white/10 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] text-indigo-100/30 mt-1 uppercase">Master Switch</p>
                            </div>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col lg:col-span-2">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Vendor Onboarding & Commissions</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 flex-1">
                        <div className="flex items-center justify-between p-8 bg-slate-50 rounded-[40px] border border-slate-100 hover:border-indigo-200 transition-colors cursor-pointer group">
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Skip manual store review</p>
                                </div>
                            </div>
                            <button
                        ...
                        <div className="space-y-4">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Marketplace Commission (%)</label>
                            <div className="relative">
                                <input
                                    type="number"
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Inventory Control</p>
                        </div>
                    </div>

                    <div className="space-y-6">
                        <div className="p-6 bg-slate-50 rounded-[32px] space-y-4">
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Stock Management</p>
                            <div className="flex gap-2">
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col lg:col-span-2">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Delivery Pricing & Timing</p>
                        </div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Delivery Charge Logic</label>
                            <select
                        ...
                        <div className="space-y-4">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Prep & Packaging SLA (Mins)</label>
                            <div className="relative">
                                <input
                                    type="number"
                    ...
                    <div className="space-y-8 relative z-10">
                        ...
                        <div className="flex items-center justify-between p-6 bg-white/5 border border-white/10 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] text-white/30 uppercase">Multiple drops per trip</p>
                            </div>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col lg:col-span-2">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Payment & Value Gates</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">COD Support</p>
                            <button
                    ...
                    <div className="grid grid-cols-2 gap-8 flex-1">
                        <div className="p-8 bg-slate-50 rounded-[40px] border border-slate-100 space-y-4">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Min Cart Value ($)</label>
                            <input
                                type="number"
                        ...
                        <div className="p-8 bg-emerald-50 rounded-[40px] border border-emerald-100 flex items-center justify-between">
                            <div>
                                <p className="text-[10px] font-black text-emerald-600 uppercase tracking-widest">Incentive Gate</p>
                ...
                <div className="bg-orange-600 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-6 mb-10 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-orange-200/50 uppercase tracking-[0.2em] mt-1">Culinary Ops Gate</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 relative z-10">
                        <div className="flex items-center justify-between p-6 bg-white/5 border border-white/10 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] text-orange-100/30 mt-1 uppercase">Master Switch</p>
                            </div>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col lg:col-span-2">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Restaurant Onboarding & Fees</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 flex-1">
                        <div className="flex items-center justify-between p-8 bg-slate-50 rounded-[40px] border border-slate-100 hover:border-orange-200 transition-colors cursor-pointer group">
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    <p className="text-sm font-black text-slate-900">Auto-Approval</p>
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Manual review skip</p>
                                </div>
                            </div>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col lg:col-span-2">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Delivery Charges & SLAs</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Mean Prep Time (Mins)</label>
                            <div className="relative">
                                <input
                                    type="number"
                ...
                <div className="bg-slate-50 p-10 rounded-[60px] border border-slate-200/50 lg:col-span-2 space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Order Limits & Thresholds</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        ...
                        <div className="p-8 bg-white rounded-[40px] border border-slate-100 flex items-center justify-between">
                            <div>
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Free Delivery</p>
                ...
                <div className="bg-slate-900 p-12 rounded-[80px] text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-6 mb-10 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-sky-400/50 uppercase tracking-[0.2em] mt-1">Global Comms Gate</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 relative z-10">
                        <div className="flex items-center justify-between p-6 bg-white/5 border border-white/10 rounded-[32px]">
                            <div>
                                ...
                                <p className="text-[10px] text-white/30 mt-1 uppercase">Master Switch</p>
                            </div>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col lg:col-span-2">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Inter-Role Messaging Perms</p>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center justify-between p-8 bg-slate-50 rounded-[40px] border border-slate-100 hover:border-sky-200 transition-colors cursor-pointer group">
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-bold text-slate-400 uppercase">Trip Coordination</p>
                                </div>
                            </div>
                            <button
                        ...
                        <div className="flex items-center justify-between p-8 bg-slate-50 rounded-[40px] border border-slate-100 hover:border-sky-200 transition-colors cursor-pointer group">
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-bold text-slate-400 uppercase">Conflict Resolution</p>
                                </div>
                            </div>
                            <button
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col lg:col-span-2">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Lifecycle Boundaries</p>
                        </div>
                    </div>
                        ...
                        <div className="p-8 bg-slate-900 rounded-[40px] text-white flex items-center justify-between">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-white/40 uppercase">Minutes after completion</p>
                                </div>
                            </div>
                            <input
                                type="number"
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Content Config</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between relative z-10">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Safety Monitoring</p>
                            </div>
                        </div>
                        <button
                ...
                <div className="bg-slate-50 p-10 rounded-[60px] border border-slate-200 space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Notification Config</p>
                        </div>
                    </div>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 px-4">
                <div className="space-y-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Enterprise</span>
                                <div className="w-1 h-1 rounded-full bg-slate-200" />
                                <span className="text-[10px] font-black text-[#0089D1] uppercase tracking-[0.2em]">Governance</span>
                            </div>
