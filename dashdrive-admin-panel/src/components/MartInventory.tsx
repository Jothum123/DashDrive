            ...
            <div className="flex bg-slate-100 p-1.5 rounded-2xl w-fit overflow-x-auto scrollbar-hide border border-slate-200/50">
                {tabs.map((tab) => (
                    <button
                        key={tab}
                        onClick={() => {
                            if (tab === 'Bulk Import') setShowBulkImport(true);
                    ...
                    >
                        {tab}
                        {tab === 'Low Stock' && <span className="ml-2 px-1.5 py-0.5 bg-amber-100 text-amber-600 rounded-md text-[9px] font-black">14</span>}
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 mt-1">
                                                    <span className="text-[10px] font-bold text-slate-400 font-small-caps uppercase">ID: {product.id}</span>
                                                    <span className="text-slate-200">|</span>
                                                    <span className="text-[10px] font-bold text-primary font-small-caps uppercase whitespace-nowrap">{product.lastUpdated}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex flex-col">
                                            <div className="flex items-baseline gap-1">
                                                ...
                                                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Gross</span>
                                            </div>
