                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-slate-50/50">
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Borrower / Program</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Principal Amount</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">EMI &amp; Tenure</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Balance Remaining</th>
                            ...
                            {loans.map((loan) => (
                                <tr key={loan.id} className="group hover:bg-slate-50/50 transition-all duration-300">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{loan.id}</span>
                                    ...
                                    <td className="px-8 py-6">
                                        ...
                                        <p className="text-[10px] font-bold text-slate-400 uppercase mt-0.5">{loan.tenure} Duration</p>
                                    </td>
                                    <td className="px-8 py-6">
