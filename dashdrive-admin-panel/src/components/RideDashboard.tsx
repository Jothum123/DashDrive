                        ...
                        <div className="relative h-[450px] bg-slate-50 rounded-[24px] overflow-hidden border border-slate-100">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-[1001]">
                                <div className="text-center px-6 pointer-events-auto bg-white/10 backdrop-blur-[2px] p-8 rounded-[40px]">
                                    <button className="px-8 py-3 bg-slate-900 text-white rounded-2xl text-[10px] font-bold font-small-caps shadow-2xl shadow-slate-900/10 hover:scale-105 active:scale-95 transition-all tracking-widest">
                                ...
                                {[
                                    ...
                                    <div key={zone.name} className="flex items-center justify-between group cursor-pointer">
                                        <div>
                                            ...
                                            <p className="text-[10px] text-slate-400 font-bold font-small-caps mt-1 tracking-wider">Target: 1,500</p>
                                        </div>
                                ...
                                {[
                                    ...
                                    <div key={item.type} className="space-y-3">
                                        <div className="flex justify-between items-end">
                                            <span className="text-[10px] font-bold text-slate-600 font-small-caps tracking-widest">{item.type}</span>
                        ...
                        <div className="space-y-9">
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-400 font-bold font-small-caps tracking-widest mt-1">1,240 Total Fleet</p>
                                </div>
                            </div>
...
const LegendItem: React.FC<{ color: string; label: string }> = ({ color, label }) => (
    <div className="flex items-center gap-3">
        ...
        <span className="text-[10px] font-bold text-slate-500 font-small-caps tracking-widest">{label}</span>
    </div>
);
