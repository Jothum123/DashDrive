        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="bg-white rounded-[40px] border border-slate-100 shadow-xl shadow-slate-200/50 overflow-hidden">
                ...
                <div className="p-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button className="flex items-center gap-2 px-6 py-4 bg-slate-50 hover:bg-slate-100 text-slate-900 rounded-[20px] text-sm font-black uppercase tracking-widest transition-all">
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-slate-50/50">
                                ...
                                <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Driver Info</th>
                                <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Tier & Rating</th>
                                <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">KPI Metrics</th>
                                <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Earnings</th>
                                ...
                                <tr key={driver.id} className="group hover:bg-slate-50/50 transition-all duration-300">
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 mt-0.5">
                                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">ID: {driver.id}</p>
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="space-y-2">
                                            <div className="flex items-center justify-between gap-4">
                                                <span className="text-[9px] font-bold text-slate-400 uppercase">Acceptance</span>
                                            ...
                                            <div className="flex items-center justify-between gap-4">
                                                <span className="text-[9px] font-bold text-slate-400 uppercase">Cancel Rate</span>
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex flex-col gap-0.5">
                                            ...
                                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest italic">Lifetime</p>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                        <div className={cn(
                                            ...
                                            <span className="text-[10px] font-black uppercase tracking-wider">{driver.kycStatus}</span>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
            ...
            <div className="bg-emerald-500 rounded-[40px] p-10 text-white relative overflow-hidden flex flex-col lg:flex-row items-center gap-10">
                ...
                <div className="lg:w-1/3 flex justify-end gap-3 relative z-10">
                    <button className="px-8 py-4 bg-emerald-600 text-white border border-emerald-400/50 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-emerald-700 transition-all">
                        Audit Pending
                    </button>
                    <button className="px-8 py-4 bg-white text-emerald-600 rounded-2xl font-black text-xs uppercase tracking-widest shadow-2xl shadow-emerald-900/20 hover:scale-105 transition-all">
                        Verification Engine
                    </button>
                </div>
            </div>
