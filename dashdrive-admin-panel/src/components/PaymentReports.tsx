                        ...
                        <div className="h-[400px] flex items-end gap-2 px-4 pt-10">
                            {[45, 62, 58, 75, 90, 82, 95, 88, 72, 85, 92, 110].map((val, i) => (
                                <div key={i} className="flex-1 flex flex-col items-center gap-3 group/bar">
                                    ...
                                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">M{i + 1}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm flex items-center justify-between group overflow-hidden relative">
                            <div className="space-y-1">
                                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Net Revenue Delta</p>
                        ...
                        <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm flex items-center justify-between group overflow-hidden relative">
                            <div className="space-y-1">
                                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Platform Fees (Avg.)</p>
                ...
                <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={insight.title} className="p-4 bg-white/5 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors">
                                    <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest">{insight.title}</p>
                    ...
                    <div className="bg-white p-8 rounded-[40px] border border-slate-100 shadow-sm space-y-6">
                        <div className="flex justify-between items-center mb-2">
                            <h4 className="text-sm font-black text-slate-900 uppercase tracking-widest">Scheduled Reports</h4>
                            <button className="text-[10px] font-black text-primary uppercase hover:underline">Manage All</button>
                        </div>
                            ...
                            {[
                                ...
                                <div key={rep.name} className="flex items-center gap-4 group">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">{rep.freq} • Next: {rep.date}</p>
                                    </div>
