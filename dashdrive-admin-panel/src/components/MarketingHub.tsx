        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-12 gap-8">
                <div className="col-span-12 lg:col-span-8 bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm">
                    <div className="flex items-center justify-between mb-10">
                        ...
                        <div className="flex items-center gap-3">
                            <button className="px-5 py-2.5 bg-slate-50 border border-slate-100 rounded-xl text-[10px] font-bold text-slate-600 uppercase tracking-widest">Day</button>
                            <button className="px-5 py-2.5 bg-slate-900 text-white rounded-xl text-[10px] font-bold uppercase tracking-widest">Week</button>
                        </div>
                    </div>
                ...
                <div className="col-span-12 lg:col-span-4 bg-slate-900 p-10 rounded-[40px] text-white overflow-hidden relative">
                    ...
                    <button className="w-full mt-10 py-5 bg-[#0089D1] hover:bg-[#007AB8] text-white rounded-[24px] text-xs font-black uppercase tracking-widest transition-all">
                        Define New Segment
                    </button>
                </div>
            </div>
                        ...
                        <div key={i} className="p-8 bg-slate-50 rounded-[32px] border border-slate-100 group hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-500 flex items-center justify-between">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.1em]">{c.type}</span>
                                        <span className="w-1 h-1 rounded-full bg-slate-300" />
                                        <span className="text-[10px] font-black text-[#0089D1] uppercase tracking-[0.1em]">{c.performance}</span>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.2em]">Promotion</span>
                        <ChevronRight className="w-3 h-3 text-slate-300" />
                        <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.2em]">Marketing Hub</span>
                    </div>
                ...
                <div className="flex items-center gap-3 p-2 bg-white rounded-[32px] border border-slate-100 shadow-sm">
                    {['Campaigns', 'Audiences', 'Vouchers', 'Notifications'].map((tab) => (
                        <button
                            key={tab}
                ...
                <button className="flex items-center gap-3 px-10 py-4 bg-[#0089D1] text-white rounded-[24px] text-xs font-black uppercase tracking-widest hover:bg-[#007AB8] transition-all shadow-xl shadow-[#0089D1]/20 group">
