                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="border-b border-slate-50">
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Subject & ID</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">User</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Priority</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Status</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Assigned To</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4 text-right">Age</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-50">
                            {tickets.map((t, i) => (
                                <tr key={i} className="group hover:bg-slate-50/50 transition-all duration-300">
                                    <td className="py-6 px-4">
                                        <div className="flex flex-col">
                                            ...
                                            <div className="flex items-center gap-2 mt-1">
                                                <span className="text-[9px] font-bold text-slate-400 uppercase tracking-tight">{t.id}</span>
                                                <span className="w-1 h-1 rounded-full bg-slate-200" />
                                                <span className="text-[9px] font-black text-[#0089D1] uppercase tracking-widest">{t.type}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="py-6 px-4">
                                    ...
                                    <td className="py-6 px-4 text-right text-[10px] font-bold text-slate-400 uppercase tracking-tighter">
                                        {t.time}
                                    </td>
                                </tr>
                            ))}
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.2em]">Service Desk</span>
                        <ChevronRight className="w-3 h-3 text-slate-300" />
                        <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.2em]">Ticketing</span>
                    </div>
                ...
                <div className="flex items-center gap-3 p-2 bg-white rounded-[32px] border border-slate-100 shadow-sm">
                    {['Active Tickets', 'Agents', 'Performance', 'Settings'].map((tab) => (
                        <button
                            key={tab}
