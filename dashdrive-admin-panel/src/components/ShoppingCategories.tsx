        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="bg-white p-6 rounded-[32px] shadow-soft border border-slate-100/50 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-3">
                    <button className="flex items-center gap-2 px-5 py-2.5 bg-primary/5 text-primary rounded-xl text-[10px] font-bold font-small-caps tracking-widest border border-primary/20 transition-all">
                        <LayoutGrid className="w-4.5 h-4.5" />
                        Grid Layout
                    </button>
                    <button className="flex items-center gap-2 px-5 py-2.5 bg-slate-50 text-slate-400 rounded-xl text-[10px] font-bold font-small-caps tracking-widest border border-slate-100 transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 gap-6">
                    ...
                    <div key={cat.id} className="bg-white p-8 rounded-[40px] shadow-soft border border-slate-100/50 hover:shadow-xl hover:scale-[1.02] transition-all duration-500 group relative overflow-hidden">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] font-bold text-slate-400 font-small-caps tracking-[0.15em] mt-1.5 uppercase">{cat.productCount} Total Listings</p>
                            </div>

                            <div className="pt-4 border-t border-slate-50 flex items-center justify-between">
                                <span className="text-[10px] font-bold text-slate-400 bg-slate-50 px-2 py-1 rounded-md uppercase">Order: {cat.displayOrder}</span>
                        ...
                        <div className="absolute inset-0 bg-slate-900/95 backdrop-blur-md flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-full group-hover:translate-y-0 p-8 text-center pointer-events-none group-hover:pointer-events-auto">
                            <div className="w-full h-full flex flex-col justify-between">
                                <div>
                                    <p className="text-white/40 text-[10px] font-bold font-small-caps tracking-widest mb-6">SUB-CATEGORIES</p>
                                ...
                                <div className="space-y-3">
                                    <button className="w-full py-3 bg-primary text-white rounded-xl text-[10px] font-bold font-small-caps tracking-widest shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all">
                                        Manage Listings
                                    </button>
                                    <button className="w-full py-3 bg-white/10 text-white rounded-xl text-[10px] font-bold font-small-caps tracking-widest hover:bg-white/20 transition-all">
                                        Edit structure
                                    </button>
                                </div>
                            </div>
                ...
                <button className="group border-4 border-dashed border-slate-100 rounded-[40px] p-8 flex flex-col items-center justify-center text-center space-y-4 hover:border-primary/20 hover:bg-primary/5 transition-all duration-500">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest mt-1">Global Marketplace</p>
                    </div>
                </button>
            </div>
