            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <div className="px-4 py-2 bg-white rounded-xl shadow-sm border border-slate-100 flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold text-slate-600 uppercase tracking-wider">AI Model v4.2 Active</span>
                    </div>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-slate-50/50">
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Partner / Identity</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">DFS Score (0-100)</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Risk Potential</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Loan Eligibility</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Primary Factor</th>
                                ...
                                <tr key={s.id} className="group hover:bg-slate-50/50 transition-all duration-300">
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex flex-col gap-1">
                                            <span className={cn("text-xs font-black uppercase tracking-widest", getRiskColor(s.risk))}>{s.risk} Risk</span>
                                            <div className="flex items-center gap-1">
                                                ...
                                                <span className="text-[10px] font-bold text-slate-400 uppercase">{s.history}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                    ...
                                    <td className="px-8 py-6">
                                        <p className="text-[10px] font-black text-slate-900 uppercase tracking-widest">{s.factor}</p>
                                        <p className="text-[10px] font-bold text-slate-400 uppercase mt-0.5 whitespace-nowrap overflow-hidden text-ellipsis max-w-[120px]">Algorithmic Weight: 82%</p>
                                    </td>
