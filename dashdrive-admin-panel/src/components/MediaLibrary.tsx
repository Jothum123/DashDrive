                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black text-[#0089D1] uppercase tracking-[0.2em]">Visual Assets</span>
                        </div>
        ...
        <div className="max-w-[1700px] mx-auto space-y-12 pb-20 px-4">
            ...
            <div className="space-y-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-4">
                    ...
                    <button className="flex items-center gap-3 px-8 py-4 bg-indigo-600 text-white rounded-[24px] text-xs font-black uppercase tracking-widest transition-all shadow-lg shadow-indigo-600/20 hover:bg-indigo-700 hover:scale-[1.03] active:scale-95">
            ...
            <div className="max-w-4xl mx-auto p-12 bg-slate-900 rounded-[64px] text-white space-y-10 relative overflow-hidden shadow-2xl">
                ...
                <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
                    ...
                    <div>
                        <h4 className="text-2xl font-black tracking-tight text-white uppercase italic">Centralized Asset Pipeline</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                    <div className="p-6 bg-white/5 rounded-[32px] border border-white/5 space-y-3 hover:bg-white/10 transition-colors">
                        ...
                        <h5 className="text-[10px] font-black text-white uppercase tracking-widest">Edge CDN Delivery</h5>
                    ...
                    <div className="p-6 bg-white/5 rounded-[32px] border border-white/5 space-y-3 hover:bg-white/10 transition-colors">
                        ...
                        <h5 className="text-[10px] font-black text-white uppercase tracking-widest">Auto-Compression</h5>
                    ...
                    <div className="p-6 bg-white/5 rounded-[32px] border border-white/5 space-y-3 hover:bg-white/10 transition-colors">
                        ...
                        <h5 className="text-[10px] font-black text-white uppercase tracking-widest">Redundancy Layer</h5>
