    ...
    return (
        <div className="space-y-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <button className="flex items-center gap-2.5 px-8 py-3 bg-primary text-white rounded-2xl text-[10px] font-bold font-small-caps tracking-widest shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all">
                        ...
                        <div className="h-[350px] bg-slate-50 rounded-[28px] border border-slate-100 flex items-center justify-center relative overflow-hidden group">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-[1001]">
                                <div className="text-center p-10 pointer-events-auto bg-white/5 backdrop-blur-[1px] rounded-[40px]">
                                    ...
                                    <button className="mt-8 px-8 py-3 bg-slate-900 text-white rounded-2xl text-[10px] font-bold font-small-caps tracking-widest hover:scale-105 active:scale-95 transition-all shadow-xl shadow-slate-900/10">
                    ...
                    <div className="bg-amber-50 p-8 rounded-[32px] border border-amber-100/50 relative overflow-hidden group">
                        <div className="flex gap-5 relative z-10">
                            ...
                            <div>
                                ...
                                <button className="mt-5 px-6 py-2.5 bg-amber-600 text-white rounded-xl text-[10px] font-bold font-small-caps tracking-widest shadow-lg shadow-amber-600/10 hover:scale-105 transition-all">
                        ...
                        <div className="space-y-6">
                            <div className="flex justify-between items-end">
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-400 font-bold font-small-caps tracking-widest mt-1">Reqs / Matrix Hour</p>
                                </div>
...
const KPIBox: React.FC<{ label: string; value: string; color?: string }> = ({ label, value, color }) => (
    <div className="bg-white p-7 rounded-[28px] border border-slate-100/50 shadow-soft group hover:border-primary/20 transition-all">
        <p className="text-[10px] font-bold text-slate-400 font-small-caps tracking-widest mb-2.5">{label}</p>
...
const SurgeRow: React.FC<{ zone: string; trigger: string; time: string; multiplier: string; active: boolean }> = ({ zone, trigger, time, multiplier, active }) => (
    <tr className="hover:bg-slate-50/50 transition-colors group">
        ...
        <td className="px-8 py-5">
            <span className="text-[10px] font-bold text-primary bg-primary/5 px-2.5 py-1 rounded-xl border border-primary/10 font-small-caps tracking-widest">{trigger}</span>
        ...
        <td className="px-8 py-5">
            <div className={cn(
                "inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl text-[10px] font-bold font-small-caps tracking-widest",
