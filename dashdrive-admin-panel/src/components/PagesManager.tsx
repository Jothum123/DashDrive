                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Content Management</span>
                            <div className="w-1 h-1 rounded-full bg-slate-200" />
                            <span className="text-[10px] font-black text-[#0089D1] uppercase tracking-[0.2em]">Static Pages</span>
                        </div>
        ...
        <div className="max-w-[1700px] mx-auto space-y-12 pb-20 px-4">
            ...
            <div className="space-y-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-4">
                    ...
                    <button className="flex items-center gap-3 px-8 py-4 bg-purple-600 text-white rounded-[24px] text-xs font-black uppercase tracking-widest transition-all shadow-lg shadow-purple-600/20 hover:bg-purple-700 hover:scale-[1.03] active:scale-95">
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-slate-50 border-b border-slate-100">
                                    <th className="px-10 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">Page Structure</th>
                                    <th className="px-10 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">Visibility</th>
                                    <th className="px-10 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">Versioning</th>
                                    <th className="px-10 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">Author</th>
                                    ...
                                    <tr key={page.id} className="group hover:bg-slate-50/50 transition-colors">
                                        <td className="px-10 py-8">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter mt-0.5">{page.url}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-10 py-8">
                                        ...
                                        <td className="px-10 py-8">
                                            <div className="flex items-center gap-2 text-slate-500">
                                                ...
                                                <span className="text-[10px] font-black uppercase tracking-widest">{page.lastModified}</span>
                                            </div>
                                        </td>
                                        <td className="px-10 py-8">
                                            <div className="flex items-center gap-2 text-slate-500">
            ...
            <div className="max-w-4xl mx-auto p-12 bg-slate-900 rounded-[64px] text-white space-y-10 relative overflow-hidden shadow-2xl">
                ...
                <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
                    ...
                    <div>
                        <h4 className="text-2xl font-black tracking-tight text-white uppercase italic">Digital Layout Control</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                    <div className="p-6 bg-white/5 rounded-[32px] border border-white/5 space-y-3 hover:bg-white/10 transition-colors">
                        ...
                        <h5 className="text-[10px] font-black text-white uppercase tracking-widest">Global CDN</h5>
                    ...
                    <div className="p-6 bg-white/5 rounded-[32px] border border-white/5 space-y-3 hover:bg-white/10 transition-colors">
                        ...
                        <h5 className="text-[10px] font-black text-white uppercase tracking-widest">SEO Auto-gen</h5>
                    ...
                    <div className="p-6 bg-white/5 rounded-[32px] border border-white/5 space-y-3 hover:bg-white/10 transition-colors">
                        ...
                        <h5 className="text-[10px] font-black text-white uppercase tracking-widest">Usage Guard</h5>
