...
export const FinancialEngine: React.FC = () => {
    ...
    return (
        <div className="p-8 space-y-8 bg-background-light dark:bg-zinc-950 min-h-full">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-black text-white tracking-tight">Financial Engine</h2>
