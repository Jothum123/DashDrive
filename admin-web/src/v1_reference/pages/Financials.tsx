    ...
    return (
        <div className="min-h-screen bg-transparent dark:text-white/90 flex flex-col">
            <div className="p-8 pb-0">
                <h2 className="text-2xl font-black text-zinc-900 dark:text-white tracking-tight">Financials</h2>
                <p className="text-sm text-zinc-500 mt-1">Fiscal Oversight & Revenue Analysis</p>
            </div>
