    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] dark:bg-zinc-950 p-4 lg:p-8">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-2xl font-uber-bold text-gray-800 dark:text-white">Dashboard</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Real-time fleet overview and performance metrics.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    <div className="bg-white dark:bg-white/5 rounded-3xl p-8 border border-gray-100 dark:border-white/5">
                        <div className="flex items-center justify-between mb-8">
                            <h3 className="text-lg font-uber-bold text-gray-800 dark:text-white">Revenue Overview</h3>
                        </div>
                                ...
                                <AreaChart data={revenueData}>
                                    <defs>
                                        <linearGradient id="colorRev" x1="0" y1="0" x2="0" y2="1">
                                            <stop offset="5%" stopColor="#00ff90" stopOpacity={0.1} />
                    ...
                    <div className="bg-white dark:bg-white/5 rounded-3xl p-8 border border-gray-100 dark:border-white/5">
                        <div className="flex items-center justify-between mb-8">
                            <div>
                                <h3 className="text-lg font-uber-bold text-gray-800 dark:text-white">Active Drivers</h3>
                                <p className="text-sm text-gray-500 dark:text-gray-400 font-uber">Currently online fleet members</p>
                            </div>
                            <span className="bg-emerald-50 text-emerald-600 px-3 py-1 rounded-lg text-xs font-uber-bold border border-emerald-100 italic">
                            ...
                            {activeDrivers.map((driver) => (
                                <div key={driver.id} className="flex items-center justify-between group">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 rounded-full bg-brand-500/10 flex items-center justify-center text-brand-500 font-bold relative">
                                ...
                                <div key={ride.id} className="relative pl-8">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-start gap-3 relative">
                                            <div className="w-2 h-2 rounded-full border-2 border-brand-500 mt-1.5 z-10 bg-white"></div>
                                            <div>
    ...
    return (
        <div className="bg-white dark:bg-white/5 rounded-3xl p-8 border border-gray-100 dark:border-white/5 relative overflow-hidden group hover:shadow-xl transition-all duration-300">
            ...
            <div className="relative z-10">
                <p className="text-sm font-uber-medium text-gray-500 dark:text-gray-400">{title}</p>
                <h4 className="text-3xl font-uber-bold text-gray-800 dark:text-white mt-4 mb-2">{value}</h4>
                <div className="flex items-center gap-2">
                    <span className="text-[11px] font-uber-bold text-emerald-500 flex items-center gap-0.5">
                        <ArrowUpRight size={12} />
                        +{change}%
                    </span>
                    <span className="text-[11px] font-uber-medium text-gray-400">{changeText}</span>
                </div>
            </div>
        </div>
    );
