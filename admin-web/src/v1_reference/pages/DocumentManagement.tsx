...
import type { RequiredDocument } from '../../stores/adminStore';
...
export const DocumentManagement: React.FC = () => {
    ...
    // Filter documents
    const filteredDocs = requiredDocuments.filter((doc: RequiredDocument) =>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-8 space-y-4">
                        ...
                        <div className="grid gap-4">
                            {filteredDocs.map((doc: RequiredDocument) => (
                        ...
                        <div className="bg-zinc-900/50 border border-zinc-800 rounded-[40px] p-8 space-y-6 text-left">
                            ...
                            <div className="pt-6 border-t border-zinc-800 space-y-4">
                                <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest">
                                    ...
                                    <span className="text-primary">{requiredDocuments.filter((d: RequiredDocument) => d.isRequired).length}</span>
                                </div>
                                <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest">
