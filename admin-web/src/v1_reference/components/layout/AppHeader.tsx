                ...
                <div className="flex items-center gap-4 px-5 py-3 lg:py-0">
                    ...
                    <div className="flex items-center gap-3 pl-4">
                        <div className="text-right hidden sm:block">
                            <p className="text-[13px] font-uber-bold text-gray-800 dark:text-white leading-none">Jothum Thomas</p>
                            <p className="text-[10px] text-gray-500 font-uber-medium mt-1">Administrator</p>
                        </div>
                        <div className="w-10 h-10 rounded-full bg-brand-500/10 flex items-center justify-center text-brand-500 font-uber-bold text-sm">
                            JT
                        </div>
                    </div>
                </div>
