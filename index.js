...
const app = express();
app.use(cors());
app.use(express.json()); // Essential for parsing PATCH bodies
...
// New Order Webhook Endpoint
app.post("/webhooks/new-order", async (req, res) => {
    const order = req.body;
    console.log("[Webhook] New order received:", order);

    // Broadcast via socket for real-time dashboard updates
    io.emit('newIncomingOrder', order);
