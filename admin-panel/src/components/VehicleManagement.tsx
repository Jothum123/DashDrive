                ...
                {[
                    ...
                    <div key={i} className="bg-white p-8 rounded-[40px] border border-slate-100 shadow-sm group hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-500">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <span className="text-[10px] font-black text-slate-400 bg-slate-50 px-3 py-1.5 rounded-xl uppercase tracking-widest">{stat.trend}</span>
                        </div>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="border-b border-slate-50">
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Vehicle Info</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Owner / Partner</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Type</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Verification</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4">Status</th>
                                <th className="pb-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] px-4"></th>
                            </tr>
                        </thead>
                                ...
                                <tr key={i} className="group hover:bg-slate-50/50 transition-all duration-300">
                                    ...
                                    <td className="py-6 px-4">
                                        <div className="px-3 py-1 bg-slate-100 rounded-full inline-block">
                                            <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">{vh.type}</span>
                                        </div>
                                    </td>
                                    <td className="py-6 px-4">
                                        <div className={cn(
                                            ...
                                            <span className="text-[10px] font-black tracking-wider uppercase">{vh.verification}</span>
                                        </div>
                                    </td>
                                    <td className="py-6 px-4">
                                        <div className={cn(
            ...
            {[
                ...
                <div key={i} className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm space-y-8 group hover:border-[#0089D1]/30 transition-all duration-500">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] font-black text-slate-300 tracking-widest uppercase">{cat.count}</span>
                    </div>
                    <div>
                    ...
                    <button className="w-full py-4 text-[#0089D1] text-[10px] font-black uppercase tracking-widest hover:bg-[#0089D1]/5 rounded-2xl transition-all border border-[#0089D1]/10">Configure {cat.title}</button>
                </div>
            ))}
        </div>
    );
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.2em]">Management</span>
                        <ChevronRight className="w-3 h-3 text-slate-300" />
                        <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.2em]">Fleet</span>
                    </div>
                ...
                <div className="flex items-center gap-3 p-2 bg-white rounded-[32px] border border-slate-100 shadow-sm">
                    {['Vehicles', 'Attributes', 'Requests', 'Settings'].map((tab) => (
                        <button
                            key={tab}
