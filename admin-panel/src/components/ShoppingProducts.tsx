        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex bg-slate-100 p-1.5 rounded-2xl w-fit overflow-x-auto scrollbar-hide border border-slate-200/50">
                {tabs.map((tab) => (
                    ...
                    >
                        {tab}
                        {tab === 'Pending Approval' && <span className="ml-2 px-1.5 py-0.5 bg-amber-100 text-amber-600 rounded-md text-[9px] font-black">12</span>}
                        {tab === 'Out of Stock' && <span className="ml-2 px-1.5 py-0.5 bg-red-100 text-red-600 rounded-md text-[9px] font-black">04</span>}
                    </button>
                ))}
            </div>
            ...
            <div className="bg-white rounded-[40px] shadow-soft border border-slate-100/50 overflow-hidden">
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 mt-1.5 font-bold font-small-caps text-[9px] tracking-widest text-slate-400 uppercase">
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="space-y-2 max-w-[120px]">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className="text-[10px] font-bold text-slate-400 font-small-caps uppercase tracking-widest">In Stock</span>
                                            </div>
                ...
                <div className="px-8 py-5 bg-slate-50/30 border-t border-slate-50 flex items-center justify-between">
                    <p className="text-[10px] font-bold text-slate-400 font-small-caps tracking-widest uppercase">Showing 1-10 of 480 Active Products</p>
                    <div className="flex items-center gap-2">
...
const ProductStatusBadge: React.FC<{ status: ShoppingProduct['status'] }> = ({ status }) => (
    <span className={cn(
        "inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl text-[10px] font-bold font-small-caps tracking-widest uppercase border",
