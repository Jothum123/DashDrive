                ...
                <div className="absolute inset-0 pointer-events-none z-[10001]">
                    <div className="relative w-full h-full p-8 flex flex-col justify-between">
                        ...
                        <div className="flex items-start justify-between pointer-events-auto">
                            <div className="bg-white/95 backdrop-blur-md px-8 py-5 rounded-[28px] shadow-2xl border border-slate-100 animate-in slide-in-from-top-4 duration-500">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-bold text-slate-400 font-small-caps tracking-[0.2em] uppercase mb-0.5">Order Logistics Snapshot</p>
                        ...
                        <div className="flex items-center justify-between pointer-events-auto">
                            <div className="bg-slate-900/95 backdrop-blur-md px-6 py-3.5 rounded-2xl shadow-2xl text-white/90 text-[10px] font-bold font-small-caps tracking-widest animate-in slide-in-from-bottom-4 duration-500">
