        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex bg-slate-100 p-1.5 rounded-2xl w-fit overflow-x-auto scrollbar-hide border border-slate-200/50">
                {tabs.map((tab) => (
                    ...
                    >
                        {tab}
                        {tab === 'Pending' && <span className="ml-2 px-1.5 py-0.5 bg-amber-100 text-amber-600 rounded-md text-[9px] font-black">24</span>}
                        {tab === 'Returns' && <span className="ml-2 px-1.5 py-0.5 bg-rose-100 text-rose-600 rounded-md text-[9px] font-black">08</span>}
                    </button>
                ))}
            </div>
                                ...
                                <tr key={order.id} className="hover:bg-slate-50/50 transition-colors group">
                                    <td className="px-8 py-6">
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">{order.date}</span>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-1.5 mt-1">
                                                    ...
                                                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">{order.zone}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                        ...
                                        <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-widest">{order.itemsCount} Global Items</p>
                                    </td>
                                    <td className="px-8 py-6">
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">{order.deliveryType} SHIP</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                ...
                <div className="px-8 py-6 bg-slate-50/30 border-t border-slate-50 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 rounded-xl border border-emerald-100/50">
                            ...
                            <span className="text-[10px] font-black text-emerald-700 uppercase tracking-widest">Fraud Guard Active</span>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mr-4">Page 1 of 42</span>
            ...
            <div className="bg-amber-50 rounded-[32px] p-8 border border-amber-100/50 flex items-center justify-between">
                ...
                <button className="flex items-center gap-2.5 px-6 py-3 bg-amber-600 text-white rounded-xl text-[10px] font-bold font-small-caps tracking-widest shadow-xl shadow-amber-600/20 hover:bg-amber-700 transition-all">
                    Process Returns
...
const OrderStatusBadge: React.FC<{ status: ShoppingOrder['status'] }> = ({ status }) => (
    <span className={cn(
        "inline-flex items-center gap-2 px-3 py-1 rounded-xl text-[9px] font-black uppercase tracking-widest border",
