        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">Active Dispatchers</p>
                ...
                <div className="lg:col-span-8 bg-white rounded-[40px] shadow-soft border border-slate-100/50 overflow-hidden group">
                    <div className="p-8 pb-0 flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Live Parcel Concentration</p>
                        </div>
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    <div className="bg-slate-900 rounded-[40px] p-8 shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <p className="text-[10px] font-bold text-white/40 uppercase tracking-[0.2em] mb-1 font-small-caps">Revenue Yield</p>
                    ...
                    <div className="bg-white rounded-[40px] p-8 shadow-soft border border-slate-100/50">
                        <div className="flex items-center justify-between mb-6">
                            <h4 className="text-sm font-black text-slate-900 uppercase tracking-widest">Urgent Audits</h4>
                        ...
                        <button className="w-full mt-6 py-4 bg-slate-50 text-slate-400 rounded-2xl text-[10px] font-bold font-small-caps tracking-widest hover:text-primary hover:bg-primary/5 transition-all">
                            View All Incidents
                        </button>
                    </div>
                </div>
...
const KPICard: React.FC<{ title: string, value: string, trend: string, trendUp: boolean, icon: React.ReactNode, subtext: string }> = ({ title, value, trend, trendUp, icon, subtext }) => (
    <div className="bg-white p-7 rounded-[40px] shadow-soft border border-slate-100/50 group hover:shadow-xl transition-all duration-500">
        ...
        <div>
            <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest leading-none mb-1 font-small-caps">{title}</p>
    ...
    <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:border-rose-100/50 transition-colors cursor-pointer group/item">
        <div className="flex items-center gap-3">
            ...
            <div>
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter leading-none">{reason} • {location}</p>
            </div>
        </div>
