                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-slate-50/50">
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Transaction / User</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Service &amp; Reference</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Amount &amp; Method</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Platform Comm.</th>
                            ...
                            {transactions.map((tx) => (
                                <tr key={tx.id} className="group hover:bg-slate-50/50 transition-all duration-300">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-[10px] font-black text-primary uppercase">{tx.userType}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-8 py-6">
                                        ...
                                        <p className="text-[10px] font-bold text-slate-400 uppercase mt-0.5">Automated</p>
                                    </td>
                                    <td className="px-8 py-6">
                                        <div className={cn(
