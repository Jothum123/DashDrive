        ...
        <div className="space-y-8">
            ...
            <div className="flex bg-slate-100 p-1.5 rounded-2xl w-fit overflow-x-auto scrollbar-hide border border-slate-200/50">
                {tabs.map((tab) => (
                    ...
                    >
                        {tab}
                        {tab === 'New' && <span className="ml-2 px-1.5 py-0.5 bg-red-100 text-red-600 rounded-md text-[9px] font-black">08</span>}
                        {tab === 'Picking' && <span className="ml-2 px-1.5 py-0.5 bg-emerald-100 text-emerald-600 rounded-md text-[9px] font-black">12</span>}
                    </button>
                ))}
            </div>
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] text-slate-400 font-bold font-small-caps mt-1 tracking-wider">{order.customer.name}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                        ...
                                        {order.rider ? (
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="text-[9px] text-slate-400 font-bold uppercase tracking-widest">{order.eta} ETA</span>
                                                </div>
                                            </div>
                                        ) : (
                                            <button className="flex items-center gap-2 text-[9px] font-bold text-primary bg-primary/5 px-3 py-2 rounded-xl border border-primary/20 hover:bg-primary/10 transition-all uppercase tracking-widest">
                    ...
                    <div className="relative w-full max-w-2xl h-screen bg-white shadow-2xl animate-in slide-in-from-right duration-300 overflow-y-auto">
                        <div className="p-10 space-y-10">
                            ...
                            <div className="bg-slate-50/50 p-8 rounded-[32px] border border-slate-100">
                                <h4 className="text-[10px] font-bold text-slate-400 font-small-caps tracking-[0.2em] mb-8 uppercase">Picking Timeline</h4>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between">
                                    <h4 className="text-[10px] font-bold text-slate-400 font-small-caps tracking-[0.2em] uppercase">Inventory Verification (12 Items)</h4>
                                    ...
                                    {[
                                        ...
                                        <div key={i} className="flex items-center justify-between p-5 bg-white border border-slate-100 rounded-2xl hover:border-slate-200 transition-colors">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">{item.qty} QTY</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
...
const MartStatusBadge: React.FC<{ status: MartOrder['status'] }> = ({ status }) => (
    <span className={cn(
        "inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl text-[10px] font-bold font-small-caps tracking-widest uppercase",
