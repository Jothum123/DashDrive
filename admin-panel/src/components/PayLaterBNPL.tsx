                ...
                {[
                    ...
                    <div key={stat.label} className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm">
                        ...
                        <div className="flex items-end gap-3">
                            ...
                            <span className={cn("text-[10px] font-black pb-1 uppercase", stat.trend.startsWith('+') ? 'text-primary' : 'text-emerald-500')}>{stat.trend}</span>
                        </div>
                    </div>
                ))}
            </div>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-slate-50/50">
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Customer Account</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Credit Limit</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Used / Outstanding</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Expected Repayment</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Risk Status</th>
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] font-bold text-slate-400 uppercase">{acc.id}</p>
                                            </div>
                                        </div>
                                    </td>
