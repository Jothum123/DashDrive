    ...
    const renderHeader = () => (
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 px-4 mt-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black text-[#0089D1] uppercase tracking-[0.2em]">Operational Intelligence</span>
                        </div>
            ...
            <div className="flex items-center gap-4">
                <button className="flex items-center gap-3 px-8 py-4 bg-white border border-slate-200 text-slate-400 rounded-[24px] text-xs font-black uppercase tracking-widest hover:bg-slate-50 hover:text-slate-600 transition-all focus:ring-4 focus:ring-slate-100">
                ...
                <div className="flex-1 space-y-8">
                        ...
                        <div className="flex items-center justify-between relative z-10">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-2 italic">Automated Assignment Rules</p>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                            {[
                                ...
                                >
                                    ...
                                    <h4 className="text-sm font-black uppercase tracking-widest mb-2">{logic.title}</h4>
                                    <p className={cn(
                    ...
                    <div className="p-10 bg-blue-50/50 rounded-[50px] border border-blue-100 flex items-start gap-6 group hover:bg-blue-50 transition-colors duration-500">
                        ...
                        <div className="space-y-3">
                            <h4 className="text-sm font-black text-blue-900 uppercase tracking-widest">Safety Tier Integration</h4>
                            ...
                            <button className="flex items-center gap-2 text-[10px] font-black text-blue-600 uppercase tracking-widest hover:underline transition-all">
                ...
                <div className="lg:w-[500px] shrink-0 space-y-8">
                    <div className="bg-slate-900 p-12 rounded-[60px] text-white space-y-10 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="flex items-center gap-6 relative z-10">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] mt-2 italic">Hierarchy of Fulfillment</p>
                            </div>
                        </div>
                        ...
                        <button className="w-full py-6 bg-white text-slate-900 rounded-[32px] text-xs font-black uppercase tracking-[0.3em] shadow-xl hover:scale-[1.02] transition-all flex items-center justify-center gap-3">
                    ...
                    <div className="bg-white p-10 rounded-[50px] border border-slate-100 shadow-sm space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h4 className="text-sm font-black text-slate-900 uppercase tracking-widest">Real-time Triage</h4>
