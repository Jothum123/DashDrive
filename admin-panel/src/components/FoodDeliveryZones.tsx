                        ...
                        <div className="flex items-center justify-between mb-8">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-400 font-bold font-small-caps tracking-widest mt-1 uppercase">Active Polygonal Boundaries</p>
                                </div>
                            </div>
                            ...
                            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-[1000] bg-slate-900/90 backdrop-blur-md px-6 py-4 rounded-[24px] border border-white/10 shadow-2xl flex items-center gap-8">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[8px] font-bold text-slate-500 uppercase mt-1">Live Riders</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[8px] font-bold text-slate-500 uppercase mt-1">Health</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody className="divide-y divide-slate-50">
                                    {mockZones.map((zone) => (
                                        <tr key={zone.id} className="hover:bg-slate-50/50 transition-colors group">
                                            <td className="px-8 py-6">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[10px] text-slate-400 font-bold font-small-caps mt-1 tracking-wider">{zone.coverage}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-8 py-6">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-[10px] text-slate-400 font-bold font-small-caps ml-1 uppercase">Riders</span>
                                                </div>
                                            </td>
                                            <td className="px-8 py-6">
                                                <div className="flex items-center gap-2">
                                            ...
                                            <td className="px-8 py-6">
                                                <div className={cn(
                                                    "w-fit px-2.5 py-1 rounded-xl text-[10px] font-black tracking-tighter uppercase",
                            ...
                            {[
                                ...
                                <div key={stat.label} className="space-y-3">
                                    <div className="flex justify-between items-end">
                                        <span className="text-[10px] font-bold text-slate-400 font-small-caps tracking-widest uppercase">{stat.label}</span>
                    ...
                    <div className="bg-primary/5 p-8 rounded-[40px] border border-primary/10">
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <button className="mt-6 flex items-center gap-2 text-[10px] font-bold font-small-caps text-primary uppercase tracking-widest hover:gap-3 transition-all">
