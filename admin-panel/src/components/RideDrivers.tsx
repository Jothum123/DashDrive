        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-4">
                    <button className="px-8 py-3 bg-slate-900 text-white rounded-2xl text-[10px] font-bold font-small-caps tracking-widest shadow-2xl shadow-slate-900/10 hover:scale-105 active:scale-95 transition-all">
                        Onboard New Driver
                    </button>
                                ...
                                <tr key={driver.id} className="hover:bg-slate-50/50 transition-colors group">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-1.5 mt-1">
                                                    ...
                                                    <span className="text-[9px] text-slate-400 font-bold font-small-caps tracking-widest">{driver.level} Pilot</span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                        ...
                                        <div className="flex items-center gap-2 mt-2">
                                            ...
                                            <span className="text-[10px] text-slate-400 font-bold font-small-caps tracking-wider">{driver.zone} Zone</span>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                        <span className={cn(
                                            "inline-flex items-center px-3.5 py-1.5 rounded-xl text-[10px] font-bold font-small-caps tracking-widest",
                                    ...
                                    <td className="px-8 py-6">
                                        ...
                                        <p className="text-[10px] text-slate-400 font-bold font-small-caps mt-1.5 tracking-wider">{driver.trips} Trips Lifecycle</p>
                                    </td>
                                    <td className="px-8 py-6">
                                        <span className="text-sm font-display font-black text-slate-900 tracking-tight">{driver.earnings}</span>
                                        <p className="text-[10px] text-slate-400 font-bold font-small-caps mt-1.5 tracking-widest">Monthly Yield</p>
                                    </td>
                                    <td className="px-8 py-6">
