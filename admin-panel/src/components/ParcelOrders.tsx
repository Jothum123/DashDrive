        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex bg-slate-100 p-1.5 rounded-2xl w-fit overflow-x-auto scrollbar-hide border border-slate-200/50">
                {tabs.map((tab) => (
                    ...
                    >
                        {tab}
                        {tab === 'Pending' && <span className="ml-2 px-1.5 py-0.5 bg-amber-100 text-amber-600 rounded-md text-[9px] font-black">12</span>}
                        {tab === 'In Transit' && <span className="ml-2 px-1.5 py-0.5 bg-blue-100 text-blue-600 rounded-md text-[9px] font-black">42</span>}
                    </button>
                ))}
            </div>
                                    ...
                                    >
                                        <td className="px-8 py-6">
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">{order.time}</span>
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="flex flex-col gap-1.5">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-[10px] font-bold text-slate-400 uppercase">{order.weight} • {order.type}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                                            <div className="space-y-2">
                                                ...
                                                {order.courier ? (
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter truncate max-w-[80px]">{order.courier.name}</span>
                                                    </div>
                                                ) : (
                                                    <span className="text-[10px] font-bold text-rose-500 uppercase tracking-widest animate-pulse">Unassigned</span>
                                                )}
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                ...
                {selectedOrder && (
                    <div className="xl:col-span-5 space-y-6 animate-in slide-in-from-right-8 duration-500">
                        <div className="bg-white rounded-[40px] shadow-2xl border border-slate-100/50 overflow-hidden">
                            ...
                            <div className="h-64 relative bg-slate-100 overflow-hidden">
                                ...
                                <div className="absolute top-6 left-6 z-10 flex gap-2">
                                    <div className="bg-white/95 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white shadow-lg flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] font-black text-slate-900 uppercase tracking-widest">{selectedOrder.status}</span>
                                    </div>
                                    <div className="bg-slate-900/95 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/5 shadow-lg flex items-center gap-2">
                                        <span className="text-[10px] font-black text-white uppercase tracking-widest">{selectedOrder.type}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-8 space-y-8">
                                ...
                                <div className="space-y-6">
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest border-b border-slate-50 pb-2">Logistics Pipeline</p>
                                ...
                                <div className="pt-6 border-t border-slate-50 grid grid-cols-2 gap-4">
                                    <button className="flex flex-col items-center justify-center p-6 bg-slate-50 rounded-[32px] hover:bg-primary/5 hover:border-primary/20 border-2 border-transparent transition-all group">
                                        ...
                                        <span className="text-[10px] font-bold text-slate-400 group-hover:text-slate-900 uppercase tracking-tighter">Reassign Courier</span>
                                    </button>
                                    <button className="flex flex-col items-center justify-center p-6 bg-slate-50 rounded-[32px] hover:bg-rose-50 hover:border-rose-100 border-2 border-transparent transition-all group">
                                        ...
                                        <span className="text-[10px] font-bold text-slate-400 group-hover:text-slate-900 uppercase tracking-tighter">Cancel Parcel</span>
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="w-full py-5 bg-slate-900 text-white rounded-[32px] text-[10px] font-bold font-small-caps tracking-widest shadow-2xl hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-3"
                        >
