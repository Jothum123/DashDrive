    ...
    <div className="flex flex-col h-full space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="w-full pt-4 border-t border-slate-50 space-y-3">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              {driver.services.map(s => (
                <span key={s} className="px-2 py-1 bg-blue-50 text-blue-600 rounded-lg text-[9px] font-bold uppercase">{s}</span>
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-[24px] shadow-soft border border-slate-100">
          <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider mb-6">Driver Rate Info</h3>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={stat.label} className="flex flex-col items-center gap-3">
                ...
                <span className="text-[9px] font-bold text-slate-400 uppercase text-center leading-tight">{stat.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="bg-white p-6 rounded-[24px] shadow-soft border border-slate-100">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider">Wallet Info</h3>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-2 bg-slate-50/50 rounded-[20px] border border-slate-100 p-8 flex flex-col items-center justify-center text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-slate-400 uppercase tracking-wide mt-1">Collectable Cash</p>
            </div>
          </div>
            ...
            {[
              ...
              <div key={card.label} className="bg-white p-6 rounded-[20px] border border-slate-100 shadow-sm flex items-center justify-between group hover:border-primary/20 transition-all">
                <div>
                  ...
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wide mt-1">{card.label}</p>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-white p-6 rounded-[24px] shadow-soft border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider">Performance Stats</h3>
            ...
            <div className="bg-white p-6 rounded-[24px] shadow-soft border border-slate-100">
              <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider mb-6">Documents</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-[24px] shadow-soft border border-slate-100 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="px-2 py-1 bg-primary/10 text-primary rounded-lg text-[10px] font-bold uppercase">{driver.vehicle.category}</span>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                    <p className="text-[10px] text-slate-400 font-bold uppercase mb-1">Ownership</p>
                    <p className="text-xs font-bold text-slate-800">{driver.vehicle.ownership}</p>
                  </div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                    <p className="text-[10px] text-slate-400 font-bold uppercase mb-1">Trip Rate</p>
            ...
            <div className="lg:col-span-2 bg-white rounded-[24px] shadow-soft border border-slate-100 overflow-hidden">
              <div className="p-6 border-b border-slate-50">
                <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider">Vehicle Specifications</h3>
              </div>
                ...
                <div className="divide-y divide-slate-50">
                  {Object.entries(driver.vehicle.specs).slice(0, 4).map(([key, value]) => (
                    <div key={key} className="px-6 py-4 flex justify-between items-center">
                      <span className="text-xs font-bold text-slate-400 uppercase tracking-tight">{key.replace(/([A-Z])/g, ' $1')}</span>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50/50">
                    ...
                    <th className="px-6 py-4 text-[10px] font-bold text-slate-400 uppercase tracking-wider">Transaction To</th>
