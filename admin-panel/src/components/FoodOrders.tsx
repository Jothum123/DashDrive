...
export const FoodOrders: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex bg-slate-100 p-1.5 rounded-2xl w-fit overflow-x-auto scrollbar-hide">
                {tabs.map((tab) => (
                    <button
                        key={tab}
                    ...
                    >
                        {tab}
                        {tab === 'New' && <span className="ml-2 px-1.5 py-0.5 bg-red-100 text-red-600 rounded-md text-[9px] font-black">12</span>}
                    </button>
                ))}
            </div>
                                ...
                                <tr key={order.id} className="hover:bg-slate-50/50 transition-colors group">
                                    ...
                                    <td className="px-8 py-6">
                                        {order.rider ? (
                                            ...
                                            <button className="text-[9px] font-bold text-primary bg-primary/5 px-2.5 py-1.5 rounded-lg border border-primary/20 hover:bg-primary/10 transition-all uppercase tracking-widest">
                                                Assign Rider
                                            </button>
                                        )}
                                    </td>
                                    <td className="px-8 py-6">
                                        <div className="space-y-1.5">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-[10px] text-slate-400 font-bold font-small-caps tracking-widest">{order.eta} ETA</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
