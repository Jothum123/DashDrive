        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-4 bg-emerald-50 border border-emerald-100/50 p-4 rounded-3xl flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-[10px] font-black text-emerald-800 uppercase tracking-widest leading-none mb-1">AI Auto-Moderation</p>
            ...
            <div className="bg-white rounded-[40px] shadow-soft border border-slate-100/50 overflow-hidden">
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">{review.date}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                ...
                <div className="px-8 py-5 bg-slate-50/30 border-t border-slate-50 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none">Showing 1-10 of 2,420 Submissions</span>
                    </div>
                    <div className="flex items-center gap-2">
            ...
            <div className="bg-slate-900 rounded-[48px] p-12 relative overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                    ...
                    <div className="md:ml-auto">
                        <button className="flex items-center gap-3 px-8 py-4 bg-primary text-white rounded-2xl text-[11px] font-bold font-small-caps tracking-widest shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all">
                            Review AI Logs
