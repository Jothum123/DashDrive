        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={cn(
                                    "px-6 py-2.5 text-xs font-black uppercase tracking-widest rounded-xl transition-all relative overflow-hidden",
                                    activeTab === tab
                            ...
                            >
                                {tab}
                                {tab !== 'All' && tab !== 'New User' && (
                                    <div className="absolute top-0 right-1 text-[8px] font-black text-primary opacity-50">v</div>
                                )}
                            </button>
                        ))}
                    </div>
                ...
                <div className="p-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="relative">
                            <button className="flex items-center gap-2 px-6 py-4 bg-slate-50 hover:bg-slate-100 text-slate-900 rounded-[20px] text-sm font-black uppercase tracking-widest transition-all border border-transparent hover:border-slate-200">
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-slate-50/50">
                                <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] w-16">SL</th>
                                <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Customer Name</th>
                                <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Profile Status</th>
                                ...
                                <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Total Trip / Order</th>
                            ...
                            {customers.map((customer, idx) => (
                                <tr key={customer.id} className="group hover:bg-slate-50/50 transition-all duration-300">
                                    ...
                                    <td className="px-8 py-6">
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">ID: {customer.id}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="space-y-1 text-slate-500">
                                            ...
                                            <div className="flex items-center gap-2 group/info">
                                                ...
                                                <span className="text-xs font-bold font-mono tracking-tighter hover:text-slate-900 transition-colors uppercase">{customer.email}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex flex-col gap-2">
                                            <div className="flex items-center gap-1">
                                                ...
                                                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest italic ml-1">Total Impact</span>
                                            </div>
                                    ...
                                    <td className="px-8 py-6">
                                        ...
                                        <p className={cn(
                                            "text-[9px] font-black uppercase tracking-widest mt-1.5 ml-1",
            ...
            <div className="bg-slate-900 rounded-[40px] p-10 text-white relative overflow-hidden flex flex-col lg:flex-row items-center gap-10">
                ...
                <div className="lg:w-1/3 flex justify-end gap-3 relative z-10">
                    <button className="px-8 py-4 bg-slate-800 text-white border border-slate-700 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-700 transition-all">
                        Global Ban Policy
                    </button>
                    <button className="px-8 py-4 bg-primary text-slate-900 rounded-2xl font-black text-xs uppercase tracking-widest shadow-2xl shadow-primary/30 hover:scale-105 transition-all">
                        Audit Intelligence
                    </button>
                </div>
            </div>
