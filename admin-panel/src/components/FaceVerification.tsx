                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black text-[#0089D1] uppercase tracking-[0.2em]">Identity & Security</span>
                        </div>
        ...
        <div className="max-w-[1700px] mx-auto space-y-12 pb-20 px-4">
            ...
            <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-6 duration-700">
                <div className="bg-white p-12 rounded-[80px] border border-slate-100 shadow-sm space-y-12 relative overflow-hidden group">
                    ...
                    <div className="flex items-center justify-between relative z-10">
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-1 italic">AWS Biometric Engine</p>
                            </div>
                        </div>

                        <div className="flex items-center gap-8">
                            <button className="flex items-center gap-2 text-[10px] font-black text-[#0089D1] uppercase tracking-widest hover:underline">
                                <ExternalLink className="w-4 h-4" /> How it Works
                            </button>
                            <label className="flex items-center gap-4 cursor-pointer">
                                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{enabled ? 'Enabled' : 'Disabled'}</span>
                                <div
                    ...
                    <div className="space-y-10 relative z-10">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-3">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-4">Select Region *</label>
                            ...
                            <div className="space-y-3">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-4">AWS Key Integrity</label>
                                <div className="p-5 bg-emerald-50 border border-emerald-100 rounded-[32px] flex items-center gap-4">
                                    <CheckCircle2 className="w-5 h-5 text-emerald-500" />
                                    <span className="text-[10px] font-black text-emerald-700 uppercase tracking-widest">Credentials Secured</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-3">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-4">Secret Access Key *</label>
                                <div className="relative group">
                                    <input
                                        type="password"
                                        value={secretKey}
                    ...
                    <div className="flex items-center gap-4 relative z-10 pt-4">
                        <button
                            ...
                            className="flex-1 py-6 bg-slate-50 text-slate-400 rounded-[40px] text-xs font-black uppercase tracking-[0.3em] hover:bg-slate-100 transition-all border border-slate-100"
                        >
                            Reset
                        </button>
                        <button className="flex-[2] py-6 bg-blue-500 text-white rounded-[40px] text-xs font-black uppercase tracking-[0.3em] shadow-2xl shadow-blue-500/30 hover:scale-[1.02] active:scale-95 transition-all">
                            Save API Settings
                        </button>
                    </div>
                </div>
                ...
                <div className="mt-8 flex items-start gap-4 p-8 bg-blue-50/50 rounded-[40px] border border-blue-100/50">
                    ...
                    <div>
                        <h4 className="text-sm font-black text-blue-900 uppercase tracking-widest">Compliance Note</h4>
