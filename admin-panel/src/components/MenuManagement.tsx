                                    ...
                                    <tr key={item.id} className="hover:bg-slate-50/50 transition-colors group">
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] text-slate-400 font-bold font-small-caps mt-1 tracking-wider">{item.id}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                                            <div className="space-y-1.5">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-[10px] font-bold font-small-caps text-slate-400 uppercase tracking-widest">{item.category}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                                            <div className="space-y-1.5">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-[9px] font-bold text-slate-400 uppercase tracking-tighter">{item.prepTime}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                                            <div className={cn(
                                                "w-fit px-3 py-1 rounded-xl text-[9px] font-black uppercase tracking-widest border",
                                        ...
                                        <td className="px-8 py-6">
                                            <div className={cn(
                                                ...
                                                <span className="text-[10px] font-bold font-small-caps tracking-widest uppercase">{item.status}</span>
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-2">
