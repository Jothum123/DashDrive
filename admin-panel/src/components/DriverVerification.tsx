        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="bg-white rounded-[40px] border border-slate-100 shadow-2xl shadow-slate-200/50 overflow-hidden">
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-slate-50/50">
                                <th className="px-10 py-5 text-[9px] font-bold text-slate-400 uppercase tracking-widest">DRIVER INFO</th>
                                <th className="px-10 py-5 text-[9px] font-bold text-slate-400 uppercase tracking-widest">SERVICE TYPE</th>
                                <th className="px-10 py-5 text-[9px] font-bold text-slate-400 uppercase tracking-widest">KYC STATUS</th>
                                <th className="px-10 py-5 text-[9px] font-bold text-slate-400 uppercase tracking-widest">RISK SCORE</th>
                                ...
                                <tr key={driver.id} className="group hover:bg-slate-50/50 transition-all duration-300">
                                    ...
                                    <td className="px-10 py-5">
                                        <div className="flex items-center gap-2">
                                            <span className="text-[9px] font-bold text-slate-400 uppercase">RIDE</span>
                                            <span className="text-[9px] font-bold text-slate-400 uppercase">FOOD</span>
                                            <span className="text-[9px] font-bold text-slate-400 uppercase">PARCEL</span>
                                        </div>
                                    </td>
                                    <td className="px-10 py-5">
                                        <span className={cn(
                ...
                <div className="p-8 border-t border-slate-50 flex items-center justify-between">
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest italic">Snapshot: 1,402 Active Compliance Logs Today</p>
                    <div className="flex items-center gap-2">
                        {[1, 2, 3, '...', 12].map((p, i) => (
            ...
            <div className="fixed inset-0 z-[9999] flex justify-end">
                ...
                <div className="relative w-full max-w-[1200px] bg-white h-full shadow-2xl animate-in slide-in-from-right duration-500 flex flex-col overflow-hidden">
                        ...
                        <div className="p-10 grid grid-cols-12 gap-8">
                            ...
                            <div className="col-span-12 lg:col-span-4 space-y-6">
                                ...
                                <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm space-y-6">
                                    <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">RISK & FRAUD ANALYTICS</h4>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 text-center">
                                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">FACE MATCH</p>
                                ...
                                {/* Service Eligibility */}
                                <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm space-y-6">
                                    <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">SERVICE ELIGIBILITY</h4>
                            ...
                            <div className="col-span-12 lg:col-span-8 space-y-8">
                                <div className="flex items-center justify-between px-2">
                                    ...
                                    <span className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">3 Documents</span>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="bg-white rounded-[24px] border border-slate-100 shadow-sm overflow-hidden p-6 space-y-6">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="px-3 py-1 bg-amber-100 text-amber-600 rounded-full text-[9px] font-black uppercase">Pending</span>
                                        </div>

                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                                <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1">VEHICLE MODEL</p>
                                                <p className="text-xs font-bold text-slate-900">{selectedDriver.vehicleModel}</p>
                                            </div>
                                            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                                <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1">PLATE NUMBER</p>
                                        ...
                                        <div className="relative aspect-video rounded-2xl overflow-hidden group">
                                            ...
                                            <div className="absolute top-4 right-4">
                                                <span className="px-3 py-1 bg-amber-500 text-white rounded-full text-[9px] font-black uppercase shadow-lg">Pending</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table className="w-full text-left">
                                            <thead>
                                                <tr className="bg-slate-50/50">
                                                    ...
                                                    <th className="px-8 py-4 text-[9px] font-bold text-slate-400 uppercase tracking-widest">ADMIN</th>
                                                    <th className="px-8 py-4 text-[9px] font-bold text-slate-400 uppercase tracking-widest">ACTION</th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-slate-50">
                                                {[
                    ...
                    <div className="px-10 py-6 border-t border-slate-100 bg-white sticky bottom-0 z-10">
                        <div className="mb-6">
                            <h5 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-3 italic">INTERNAL ADMIN NOTES</h5>
                            <textarea
