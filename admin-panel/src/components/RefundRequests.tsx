            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2 px-6 py-2.5 bg-rose-50 border border-rose-100 rounded-2xl">
                        ...
                        <span className="text-[10px] font-black text-rose-600 uppercase tracking-widest">High Fraud Alert: 2 Cases</span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-[40px] shadow-soft border border-slate-100/50 overflow-hidden">
                <div className="p-8 border-b border-slate-50 flex items-center justify-between bg-slate-50/20">
                    ...
                    <div className="flex items-center gap-3">
                        <button className="flex items-center gap-2 px-5 py-2.5 bg-white border border-slate-200 rounded-xl text-[10px] font-bold font-small-caps tracking-widest text-slate-500 hover:text-primary transition-all">
                                ...
                                <tr key={refund.id} className="hover:bg-slate-50/80 transition-all group">
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Order: {refund.orderId}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                        <div className="space-y-1.5 max-w-[240px]">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-[9px] font-bold text-slate-300 uppercase">{refund.timestamp}</span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all">
                                            <button className="px-4 py-2 bg-slate-900 text-white rounded-xl text-[9px] font-bold uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-lg shadow-slate-900/10">
                                                Audit
                                            </button>
