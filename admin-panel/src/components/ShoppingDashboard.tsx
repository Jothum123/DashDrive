                ...
                <div className="lg:col-span-8 bg-white p-8 rounded-[40px] shadow-soft border border-slate-100/50">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-xs text-slate-400 font-bold font-small-caps tracking-widest mt-1 uppercase">Revenue Growth vs Last Period</p>
                        </div>
                        <div className="flex bg-slate-50 p-1 rounded-xl">
                            <button className="px-4 py-1.5 rounded-lg text-[9px] font-black uppercase bg-white shadow-sm text-primary">Daily</button>
                            <button className="px-4 py-1.5 rounded-lg text-[9px] font-black uppercase text-slate-400 hover:text-slate-600">Weekly</button>
                        </div>
                    </div>
                ...
                <div className="lg:col-span-4 bg-white p-8 rounded-[40px] shadow-soft border border-slate-100/50 flex flex-col">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-xs text-slate-400 font-bold font-small-caps tracking-widest mt-1 uppercase">Merchant Revenue Ranking</p>
                        </div>
                            ...
                            <div key={i} className="flex items-center justify-between group cursor-pointer hover:translate-x-1 transition-transform">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-slate-400 font-bold font-small-caps uppercase">#{i + 1} Marketplace Rank</p>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <p className="text-sm font-black text-slate-950">{vendor.rev}</p>
                                    <p className="text-[9px] text-emerald-500 font-bold uppercase tracking-widest">+4.2%</p>
                                </div>
                            </div>
                        ))}
                    </div>

                    <button className="w-full mt-8 py-4 bg-slate-50 text-slate-600 rounded-2xl text-[10px] font-bold font-small-caps tracking-widest hover:bg-slate-100 transition-all flex items-center justify-center gap-2">
                ...
                <div className="bg-white p-8 rounded-[40px] shadow-soft border border-slate-100/50">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-xs text-slate-400 font-bold font-small-caps tracking-widest mt-1 uppercase">GMV Contribution by Type</p>
                        </div>
                ...
                <div className="bg-white p-8 rounded-[40px] shadow-soft border border-slate-100/50">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-xs text-slate-400 font-bold font-small-caps tracking-widest mt-1 uppercase">High Demand / Low Inventory</p>
                        </div>
                            ...
                            <div key={i} className="p-4 bg-slate-50 border border-slate-100 rounded-2xl flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[9px] text-slate-400 font-bold uppercase">{item.vendor}</p>
                                    </div>
                                </div>
                                <span className={cn(
                    ...
                    <div className="relative z-10 space-y-8">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-white/40 font-bold font-small-caps tracking-widest mt-1 uppercase">Smart Marketplace Insights</p>
                            </div>
                        ...
                        <div className="pt-8 border-t border-white/5 space-y-4">
                            <div className="flex items-center justify-between text-[11px] font-bold font-small-caps tracking-widest text-white/40 uppercase">
...
const KPICard: React.FC<KPICardProps> = ({ title, value, change, icon, color }) => (
    <div className="bg-white p-6 rounded-[32px] shadow-soft border border-slate-100/50 hover:shadow-xl hover:scale-[1.02] transition-all duration-500 group">
        ...
        <div>
            <p className="text-[10px] font-bold text-slate-400 font-small-caps tracking-widest uppercase mb-1">{title}</p>
...
const CategoryProgress: React.FC<{ label: string, percent: number, color: string }> = ({ label, percent, color }) => (
    <div className="space-y-2">
        <div className="flex items-center justify-between text-[11px] font-bold font-small-caps tracking-widest uppercase">
