                ...
                <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm space-y-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Environment URL</label>
                ...
                <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm space-y-8 text-black">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button className="py-4 bg-slate-900 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-800 transition-all">Rotate Keys</button>
                            <button className="py-4 bg-white border border-slate-100 text-slate-900 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-50 transition-all">Documentation</button>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-slate-900 p-10 rounded-[40px] text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-4 mb-8 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-white/30 uppercase tracking-widest mt-1">Infrastructure Setup</p>
                        </div>
                    </div>
                        ...
                        {['Development', 'Staging', 'Production'].map((env) => (
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="font-black uppercase tracking-widest text-[10px]">{env}</span>
                                </div>
                ...
                <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Platform Thresholds</p>
                            </div>
                        </div>
                        <button
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 space-y-3">
                            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Android Min</p>
                            <input
                                type="text"
                        ...
                        <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 space-y-3">
                            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest">iOS Min Build</p>
                            <input
                                type="text"
                                value={minIosVersion}
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-3 mt-2">
                                    <div className="flex items-center gap-1.5 px-3 py-1 bg-slate-100 rounded-full">
                                        ...
                                        <span className="text-[8px] font-black text-slate-500 uppercase">Last: {lastCleanDate}</span>
                                    </div>
                                    <div className="flex items-center gap-1.5 px-3 py-1 bg-emerald-50 rounded-full">
                                        <Activity className="w-2.5 h-2.5 text-emerald-500" />
                                        <span className="text-[8px] font-black text-emerald-600 uppercase">Health: 98%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Transaction Gateways</p>
                        </div>
                    </div>
                    <div className="space-y-4 flex-1">
                        {['Stripe', 'PayPal', 'Flutterwave', 'Razorpay'].map((gateway) => (
                            <div key={gateway} className="flex items-center justify-between p-5 bg-slate-50 rounded-[32px] border border-slate-100 group hover:border-indigo-200 transition-all">
                                <span className="text-xs font-black text-slate-900 uppercase tracking-widest">{gateway}</span>
                                <button
                                    onClick={() => {
                ...
                <div className="bg-slate-900 p-10 rounded-[60px] text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-4 mb-8 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-white/30 uppercase tracking-widest mt-1">Geospatial Engine</p>
                        </div>
                    </div>
                    <div className="space-y-4 relative z-10">
                        {['Google Maps', 'Mapbox', 'OpenStreetMap'].map((provider) => (
                            ...
                            >
                                <span className="text-xs font-black uppercase tracking-widest">{provider}</span>
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8 flex flex-col">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">SMS & Notification</p>
                        </div>
                    </div>
                    <div className="space-y-6">
                        <div className="space-y-2">
                ...
                <div className="bg-white p-10 rounded-[60px] border border-slate-100 shadow-sm space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Access Control Policies</p>
                        </div>
                    </div>
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="p-6 bg-white border border-slate-100 rounded-[32px] space-y-3">
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Session TTL (Min)</p>
                                <input
                                    type="number"
                    ...
                    <div className="space-y-8 relative z-10">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-white/30 uppercase tracking-widest mt-1">Brute Force Prevention</p>
                            </div>
                        </div>
                        <div className="space-y-6">
                            <div className="p-6 bg-white/5 border border-white/10 rounded-[32px] flex items-center justify-between">
                                <span className="text-xs font-black uppercase tracking-widest text-white/60">Max Failed Attempts</span>
                                <input
                                    type="number"
                            ...
                            <div className="p-6 bg-white/5 border border-white/10 rounded-[32px] flex items-center justify-between">
                                <span className="text-xs font-black uppercase tracking-widest text-white/60">Lockout Duration</span>
                    ...
                    <div className="flex-1 space-y-8">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Cross-Module Access Control</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {['Super Admin', 'Operator', 'Finance', 'Support'].map(role => (
                                <div key={role} className="p-6 bg-slate-50 border border-slate-100 rounded-[32px] text-center">
                                    <p className="text-[10px] font-black text-slate-900 uppercase tracking-widest">{role}</p>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Real-time Event Webhooks</p>
                        </div>
                    </div>
                    <div className="flex gap-4">
                        <button className="px-8 py-4 bg-slate-50 border border-slate-100 rounded-[24px] text-[10px] font-black uppercase tracking-widest hover:bg-slate-100 transition-all">Test Webhook</button>
                        <button className="px-8 py-4 bg-slate-900 text-white rounded-[24px] text-[10px] font-black uppercase tracking-widest shadow-xl shadow-slate-200 hover:scale-[1.02] transition-all">Add Endpoint</button>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                ...
                                />
                                <button className="absolute right-6 top-1/2 -translate-y-1/2 text-slate-300 hover:text-slate-900 font-black uppercase text-[10px] tracking-widest">Reveal</button>
                            </div>
                        </div>
                    </div>
                    <div className="bg-slate-50 p-8 rounded-[40px] border border-slate-100 space-y-6">
                        <h4 className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Active Event Triggers</h4>
                        <div className="space-y-3">
                    ...
                    {[1, 2, 3].map(i => (
                        <div key={i} className="flex items-center justify-between p-6 bg-slate-50 border border-slate-100 rounded-[32px] group hover:bg-white hover:shadow-lg transition-all cursor-pointer">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-slate-900 uppercase tracking-widest">trip.completed</p>
                                    <p className="text-[8px] font-bold text-slate-400 mt-1">ID: evt_0lx95sh28f • {i * 2}m ago</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4">
                                <span className="text-[10px] font-black text-slate-300 uppercase">200 OK</span>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.2em]">Business & Config</span>
                        <ChevronRight className="w-3 h-3 text-slate-300" />
                        <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.2em]">System</span>
                    </div>
