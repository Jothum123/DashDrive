        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="flex items-center gap-2.5 px-6 py-2.5 bg-slate-900 text-white rounded-2xl text-[10px] font-bold font-small-caps tracking-widest shadow-xl shadow-slate-900/10 hover:scale-105 active:scale-95 transition-all">
            ...
            {/* Sub-Tabs */}
            <div className="flex bg-slate-100 p-1.5 rounded-2xl w-fit overflow-x-auto scrollbar-hide border border-slate-200/50">
                {tabs.map((tab) => (
                    <button
                        key={tab}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-white p-8 rounded-[40px] shadow-soft border border-slate-100/50 space-y-8">
                            ...
                            <button className="w-full py-4 bg-primary text-white rounded-2xl text-[10px] font-bold font-small-caps tracking-widest shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all mt-4">
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="bg-slate-50/30">
                                            <th className="px-8 py-5 text-[9px] font-bold text-slate-400 uppercase tracking-widest">Zone Profile</th>
                                            <th className="px-8 py-5 text-[9px] font-bold text-slate-400 uppercase tracking-widest">Pricing Structure</th>
                                            <th className="px-8 py-5 text-[9px] font-bold text-slate-400 uppercase tracking-widest">Service Status</th>
                                            <th className="px-8 py-5 text-[9px] font-bold text-slate-400 uppercase tracking-widest">Actions</th>
                                        </tr>
                                    </thead>
                                                ...
                                                <td className="px-8 py-6">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span className="text-[10px] text-slate-400 font-bold uppercase tracking-tighter">{rule.activeRiders} Active Riders</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="px-8 py-6">
                                                    <div className="flex items-center gap-6">
                                                        <div className="space-y-1">
                                                            <p className="text-[9px] text-slate-400 font-bold font-small-caps tracking-widest uppercase">Base Fee</p>
                                                            <p className="text-sm font-black text-slate-900">{rule.baseFee}</p>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <p className="text-[9px] text-slate-400 font-bold font-small-caps tracking-widest uppercase">Extra Surge</p>
                        ...
                        <div className="bg-slate-900 rounded-[32px] p-8 flex items-center justify-between overflow-hidden relative">
                            ...
                            <div className="flex items-center gap-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/40 text-[10px] font-bold font-small-caps tracking-widest uppercase mt-1">Global imbalance: Moderately High</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 relative z-10">
                                <div className="text-right">
                                    <p className="text-white font-black text-2xl tracking-tighter">1.25x</p>
                                    <p className="text-emerald-400 text-[9px] font-bold uppercase tracking-widest">Recommended</p>
                                </div>
                ...
                <div className="bg-white p-12 rounded-[48px] border border-slate-100 shadow-soft text-center space-y-8">
                    ...
                    <div className="flex justify-center gap-4">
                        <div className="w-1/3 p-6 bg-white border border-slate-100 rounded-3xl space-y-4 shadow-sm">
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Per KM Rate</p>
                        ...
                        <div className="w-1/3 p-6 bg-white border border-slate-100 rounded-3xl space-y-4 shadow-sm">
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Max Delivery Radius</p>
...
const PricingField: React.FC<{ label: string, value: string, icon: React.ReactNode, suffix?: string }> = ({ label, value, icon, suffix }) => (
    <div className="space-y-2">
        <label className="text-[10px] font-bold text-slate-400 font-small-caps tracking-widest uppercase flex items-center gap-2">
            {React.cloneElement(icon as React.ReactElement, { className: "w-3 h-3" })}
            {label}
        </label>
        <div className="relative group/field">
            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[9px] font-black text-slate-400 bg-slate-100 px-2 py-1 rounded-md uppercase tracking-tighter">{suffix}</span>
            <input
                type="text"
                defaultValue={value}
