            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <div className="px-4 py-2 bg-rose-50 border border-rose-100 rounded-xl flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold text-rose-600 uppercase tracking-wider">3 High Risk Flagged</span>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                        <div className="flex p-1 bg-slate-50 rounded-2xl w-fit">
                            {['Pending', 'Approved', 'Rejected', 'Processed', 'All'].map((tab) => (
                                <button
                                    key={tab}
                                    onClick={() => setActiveTab(tab as PayoutStatus)}
                                    className={cn(
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-slate-50/50">
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Request / Driver</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Amount</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Method &amp; Destination</th>
                                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Risk Level</th>
                            ...
                            {requests.map((req) => (
                                <tr key={req.id} className="group hover:bg-slate-50/50 transition-all duration-300">
                                    ...
                                    <td className="px-8 py-6">
                                        ...
                                        <p className="text-[10px] font-bold text-slate-400 uppercase mt-0.5">Automated Check: Pass</p>
                                    </td>
                                    <td className="px-8 py-6">
                                        ...
                                        <p className="text-[10px] font-bold text-slate-400 uppercase mt-1">{req.destination}</p>
                                    </td>
                                    <td className="px-8 py-6">
                                        <div className={cn(
